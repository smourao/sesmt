...
for($x=1;$x<pg_num_rows($res);$x++){
	...
	if(file_exists("../erp/2.0/modules/repasse/relatorio/repasse_pdf/".$buffer[$x][cod_clinica]."/REP_".$mes."_".$ano.".pdf")){
		...
		$link .= "<a href='http://sesmt-rio.com/erp/2.0/modules/repasse/relatorio/?id=".$buffer[$x][cod_clinica]."&mes=".$mes."&ano=".$ano."'>AQUI</a>";
		...
		$email = $buffer[$x][email_clinica].";suporte@ti-seg.com; webmaster@sesmt-rio.com; comercial@sesmt-rio.com";
