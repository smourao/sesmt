...
$msg = "Olá! Luciana, servimo-nos deste e-mail para informa-la que um ASO AVULSO foi agendado pelo site!<br> 
...
$msg2 = "Olá! Pedro, servimo-nos deste e-mail para informa-la que um ASO AVULSO foi agendado pelo site!<br> 
		<b>Encaminhamento Nº: </b>".$cod_aso." <br>
		<b>Cliente: </b>".$cliente[razao_social]." <br> 
		<b>Funcionário: </b>".$funcionario[0][nome_func]." <br>
		<b>Tipo de ASO: </b>".$tipo_exame;
$mail_list2 = "webmaster@sesmt-rio.com";
mail($mail_list2, "SESMT - ASO Nº: ".$cod_aso, $msg2, $headers);
