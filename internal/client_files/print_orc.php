...
$orc_n = (int)(anti_injection($_GET[cod_orc]));

$sql = "SELECT * FROM site_orc_info WHERE cod_orcamento = $orc_n AND cod_cliente = ".(int)(anti_injection($_GET[cod_cliente]));
$resu = pg_query($sql);
...
if(pg_num_rows($resu)){
    ...
    $produtos = pg_fetch_all($result);
    	...
    	$query_cli = "SELECT * FROM cliente WHERE cliente_id = ".(int)(anti_injection($_GET[cod_cliente]));
    ...
    $msg = "<!DOCTYPE HTML PUBLIC -//W3C//DTD HTML 4.0 Transitional//EN>
       <HTML>
       <HEAD>
          <TITLE>SESMT® - Proposta Comercial</TITLE>
    ...
    <table width=\"100%\" border=\"0\" cellpadding=0 cellspacing=0>
    	<tr>
            ...
            if($orc_n != "")
                $msg.= str_pad($orc_n, 3, "0", STR_PAD_LEFT);
