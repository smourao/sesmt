...
if($_POST && $_POST[btnSaveFunc]){
    ...
    // -- ADD FUNC DATA --------------------------------------------------------------------------------------
        ...
        if(pg_num_rows(pg_query($sql)) <= 0){
            ...
            civil, rg, cep, estado, img_url, cod_status, pis, email_func)
            VALUES
            ('$max', '".$nome_func."', '".anti_injection($_POST[endereco])."',
            ...
            '$_POST[img_url]', 1, '".anti_injection($_POST[pis])."', '".anti_injection($_POST[email_func])."')";
...
<tr>
    <td width=180>RG:</td>
    <td><input onpaste="return false;" type=text class='' name='rg' id='rg' value='<?=$fun[rg]?>' onkeyup="change_classname('rg', 'required');"></td>
</tr>
<tr>
...
<tr>
    ...
    <td><input onpaste="return false;" type=text id='nascimento' name='nascimento' value='<?=$fun[data_nasc_func]?>' size=10 maxlength=10 onkeypress="formatar(this, '##/##/####');" onkeydown="return only_number(event);" class='required' onkeyup="change_classname('nascimento', 'required');"></td>
</tr>
<tr>
...
<tr>
    ...
    <td><input type=text onpaste="return false;" class='' name='email_func' id='email_func' value='<?=$fun[email_func]?>' size='30'></td>
</tr>
...
<tr>
<td width=180>CEP:</td>
<td><input onpaste="return false;" type=text id='cep' name='cep' value='<?=$fun[cep]?>' size=10 maxlength="9" onkeydown="return only_number(event);" onkeypress="formatar(this, '#####-###');" size=30 class='' onblur="check_cep(this);" onkeyup="change_classname('cep', 'required');">&nbsp;<span id='loading_cep'></span></td>
</tr>
<tr>
...
<td><input onpaste="return false;" type=text id='admissao' name='admissao' value='<?=$fun[data_admissao_func]?>' size=10 maxlength=10 onkeypress="formatar(this, '##/##/####');" onkeydown="return only_number(event);" class='required' onkeyup="change_classname('admissao', 'required');"></td>
</tr>
<tr>
<td width=180>CBO:</td>
...
<tr>
<td width=180>PIS:</td>
<td><input type=text id='pis' name='pis' value='<?=$fun[pis]?>' size=10 maxlength="11" onkeydown="return only_number(event);" class='required' onkeyup="change_classname('cbo', 'required');"></td>
</tr>
<tr>
