...
ob_start();
    ...
    if($_GET[sem_timbre]){
        ...
        $cabecalho .= "<BR>";
        $cabecalho .= "E MONITORAMENTO DE ATIVIDADES NO TRABALHO LTDA";
        $cabecalho .= "";
        $cabecalho .= "</td>";
...
/****************************************************************************************************************/
    ...
    $code .= "(b) Fornecer todos os dados cadastrais de seus empregados para que sejam providenciados os prontuários clínicos individuais. Informar com antecedência os funcionários admitidos, demitidos, mudança de função e retorno de licença e fornecer dados da contratada anterior à contratação da, SESMT Serviços Especializados de Segurança e Medicina do Trabalho Ltda para solicitação do arquivo físico junto ao mesmo para que a guarda e conservação do referido arquivo passe a responsabilidade do médico coordenador atual força desse contrato;";
    $code .= "<p align=justify>";
...
/****************************************************************************************************************/
    ...
    $code .= "SESMT SERVIÇOS ESPECIALIZADOS DE SEGURANÇA<BR>E MONITORAMENTO DE ATIVIDADES NO TRABALHO LTDA";
    $code .= "<BR>";
...
if(!empty($show_adeno_4)){
    ...
    $code .= "<p align=justify>";
    $code .= "<b>Anexo 2.1</b> O acesso do profissional de segurança da Sesmt Serviços Especializados em Segurança e Monitoramento de Atividades no Trabalho Ltda, se dará em dia e hora marcada e definida em agenda de visita apresentada pelo CONTRATADO;";
    $code .= "<p align=justify>";
    $code .= "<b>Anexo 2.2</b> Nosso profissional se apresentará a pessoa designada pelo CONTRATANTE na sua entrada e na sua saída com cartão de anotação de ponto de chegada e saída para controle da Sesmt Serviços Especializados em Segurança e Monitoramento de Atividades no Trabalho Ltda;";
    $code .= "<p align=justify>";
