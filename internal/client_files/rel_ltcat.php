<center><img src='images/relatorios_ltcat.jpg' border=0></center>
<?PHP
if($_GET[cod_cgrt] && is_numeric($_GET[cod_cgrt])){
    ...
    if($buf[ppra_enabled]){
        ...
        echo "Você está visualizando o relatório do LTCAT referênte ao ano de <b>{$buf[ano]}</b>. Caso haja a necessidade de uma
        ...
        echo "<iframe scrolling='yes' onload=\"document.getElementById('ppra_loading').style.display = 'none';\" src='http://sesmt-rio.com/erp/2.0/modules/cgrt/relatorios/ltcat/?cod_cgrt=".base64_encode((int)($_GET[cod_cgrt]))."&html=0' frameborder=0 width=100% height=500 allowtransparency='true'></iframe>";
        echo "<p>";
        echo "<center>";
        ...
        echo "<div class='novidades_text'>";
        echo "<p align=justify>";
        echo "O relatório do LTCAT selecionado não está disponível ou não foi finalizado.
    ...
    if(pg_num_rows($res)){
        echo "<div class='novidades_text'>";
        echo "<p align=justify>";
        echo "Selecione abaixo o ano de referência do LTCAT que deseja exibir:";
        echo "</div>";
        ...
        for($x=0;$x<pg_num_rows($res);$x++){
            ...
            echo "<tr>";
                ...
                if($buf[$x][ppra_enabled])
                    ...
                    echo "<a href='#' onclick=\"window.open('erp/2.0/modules/cgrt/relatorios/ltcat/?cod_cgrt=".base64_encode((int)($buf[$x][cod_cgrt]))."', '');\"><img src='images/ico-view.png' border=0 alt='Visualizar relatório' title='Visualizar relatório'></a>";
                else
                    echo "&nbsp;";
                echo "</td>";
            echo "</tr>";
        ...
        echo "<div class='novidades_text'>";
        echo "<p align=justify>";
        echo "Não foram encontrados relatórios do LTCAT para sua empresa. Se existem relatórios em andamento, estes ainda não foram finalizados.";
        echo "</div>";
    }
}
?>
