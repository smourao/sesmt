...
$query_insert = "INSERT INTO aso (cod_aso, cod_cliente, cod_setor, aso_data, cod_func, tipo_exame, cod_clinica)
        VALUES ({$cod_aso}, {$_GET[cliente]}, {$_GET[set]}, '$data_agendamento', {$_GET[col]}, '".utf8_decode($tipo_exame)."', {$_GET[cl]})";
...
if($_GET['tp'] == 4){
  $nsql = "UPDATE funcionarios SET cod_funcao = $nf WHERE cod_func = ".$_GET[col]." AND  cod_cliente = ".$_GET[cliente]." ";
  $nquery = pg_query($nsql);
}

if($_GET['tp'] == 2){
  $nsql = "UPDATE funcionarios SET cod_status = 0 WHERE cod_func = ".$_GET[col]." AND  cod_cliente = ".$_GET[cliente]." ";
  $nquery = pg_query($nsql);
}
...
$sql = "SELECT f.*, fe.cod_exa as exame_id, exa.especialidade as descricao, fun.nome_funcao, fun.dsc_funcao
    ...
    WHERE f.cod_cliente = '".$_GET['cliente']."' AND f.cod_func = {$_GET['col']} AND f.cod_funcao = fe.cod_fun
...
/****************************************************************************************************************/
  ...
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
  $msg_site .= "<tr>";
    $msg_site .= "<td align=justify><b>Clínica:</b> ".utf8_encode($clinica['razao_social_clinica'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table>";
  
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=60%><b>Endereço:</b> ".utf8_encode($clinica['endereco_clinica'])."</td>";
  ...
  $msg_site .= "<td align=justify ><b>Bairro:</b> ".utf8_encode($clinica['bairro_clinica'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table>";
  
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify><b>Ponto de Referência:</b> ".utf8_encode($clinica['referencia_clinica'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table><br>";
  
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Assunto:</b> Atendimento para ASO ".utf8_encode($tipo_exame)."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table>";
  
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Encaminhado:</b> ".utf8_encode($funcionario[0]['nome_func'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table>";
  
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=60%><b>Função:</b> ".utf8_encode($funcionario[0]['nome_funcao'])."</td>";
  ...
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Exames a serem realizados:</b> ".utf8_encode($tipo_exames)."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table><br>";
  ...
  $msg_site .= "<tr>";
    ...
    $msg_site .= "<td align=justify width=70%><b>Empresa Solicitante:</b> ".utf8_encode($cliente['razao_social'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table><br>";
  ...
  $msg_site .= "<td align=justify width=70%><b>Resp. Solicitante</b> ".utf8_encode($cliente['nome_contato_dir'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table><br>";
  ...
  $msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
  $msg_site .= "<td align=justify width=100%><b>Resp. Solicitante</b> ".utf8_encode($cliente['endereco']).", ".utf8_encode($cliente['bairro']).", ".utf8_encode($cliente['municipio']).", ".utf8_encode($cliente['estado'])." - CEP: {$cliente['cep']}</td>";
    $msg_site .= "</tr>";
  $msg_site .= "</table><br>";
  ...
  if($clinica['segunda']=='segunda' || $clinica['terca']=='terca' || $clinica['quarta']=='quarta' || $clinica['quinta']=='quinta' || $clinica['sexta']=='sexta'){
    $msg_site .= "<tr>";
    $msg_site .="<td align=justify width=30%><b>OBS: ".utf8_encode($clinica['motivo'])."</b></td>";
    $msg_site .= "</tr>";
  }
  $msg_site .= "<tr>";
...
/****************************************************************************************************************/
  ...
  $msg_site .= "<tr>";
    ...
    $msg_site .= "</tr>";
  $msg_site .= "<tr>";
    $msg_site .= "<td align=justify colspan=5><b>Clínica:</b> ".utf8_encode($clinica['razao_social_clinica'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "<tr>";
    $msg_site .= "<td align=justify colspan=5><b>Empresa:</b> ".utf8_encode($cliente['razao_social'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "<tr>";
    $msg_site .= "<td align=justify colspan=5><b>Nome:</b> ".utf8_encode($funcionario[0]['nome_func'])."</td>";
    $msg_site .= "</tr>";
  $msg_site .= "<tr>";
    $msg_site .= "<td align=justify colspan=2 width=40%><b>Função Atual:</b> ".utf8_encode($funcionario[0]['nome_funcao'])."</td>";
  ...
  $msg_site .= "<td align=justify width=20%><b>Natural:</b> </td>";
    $msg_site .= "</tr>";
  $msg_site .= "<tr>";
    $msg_site .= "<td align=justify colspan=5><b>Endereço:</b> ".utf8_encode($funcionario[0]['endereco_func'])."</td>";
    $msg_site .= "</tr>";
    $msg_site .= "</table>";
...
mail($mail_list, "SESMT - ASO Nº: ".$cod_aso, utf8_decode($msg), utf8_decode($headers));

mail('suporte@ti-seg.com', 'Agendamento de ASO Cliente', utf8_decode($msg_site), utf8_decode($headers));
mail('webmaster@sesmt-rio.com', 'Agendamento de ASO Cliente', utf8_decode($msg_site), utf8_decode($headers));
mail($mail_list, 'Agendamento de ASO Cliente', utf8_decode($msg_site), utf8_decode($headers));
...
$mpdf->WriteHTML(utf8_decode($msg_site));
