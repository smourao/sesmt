...
<!-- CORPO -->
    ...
    Endereço: <b><span id=spanend OnClick="tTOs('end', 'spanend', 45);"><input type=text  class=text name=end id=end size=45 OnBlur="check('end', 'spanend');"  onKeyPress="if ((window.event ? event.keyCode : event.which) == 13) { nextfield(); }"></span></b>,
    Nº <b><span id=spannum OnClick="tTOs('num', 'spannum', 3);"><input type=text  class=text name=num id=num size=3 OnBlur="check('num', 'spannum');"  onKeyPress="if ((window.event ? event.keyCode : event.which) == 13) { nextfield(); }"></span></b>
    ...
    Municípo: <b><span id=spanmunicipio OnClick="tTOs('municipio', 'spanmunicipio', 15);"><input type=text  class=text name=municipio id=municipio size=15 OnBlur="check('municipio', 'spanmunicipio');"  onKeyPress="if ((window.event ? event.keyCode : event.which) == 13) { nextfield(); }"></span></b>
