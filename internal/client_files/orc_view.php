...
if(pg_num_rows($roi)){
    ...
    echo "<div style=\"text-align: right;\"><img class='curhand' src='images/print-version.jpg' border=0 alt='Versão para impressão' title='Versão para impressão' onclick=\"newwindow('erp/2.0/modules/cad_cliente/orc/orcamentos/?cod_orcamento=".base64_encode((int)($orcinfo[cod_orcamento]))."',800,600);\"></div>";
