...
/****************************************************************************************************************/
    ...
    $msg_site .= "<tr>";
    $msg_site .= "<td align=center><b>ENCAMINHAMENTO MÉDICO COMPLEMENTAR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nº ".str_pad($count2[0]['id'], 4,"0",STR_PAD_LEFT)."</b></td>";
    $msg_site .= "</tr>";
	...
	$msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Assunto:</b></td>";
    $msg_site .= "</tr>";
	$msg_site .= "</table>";
	...
	$msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Tipo dos Exames:</b> $tipo_exames</td>";
    $msg_site .= "</tr>";
	$msg_site .= "</table><br>";
	
	$msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Assunto:</b> Atendimento para</td>";
    $msg_site .= "</tr>";
    $msg_site .= "</table>";
	
	$msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=30%><b>Empresa Solicitante:</b> {$cliente['razao_social']}</td>";
    $msg_site .= "</tr>";
    $msg_site .= "</table>";
	
	$msg_site .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=50%><b>CNPJ:</b> {$cliente['cnpj']}</td>";
	$msg_site .= "<td align=justify width=50%><b>Resp. Solicitante:</b> {$cliente['nome_contato_dir']}</td>";
    $msg_site .= "</tr>";
    $msg_site .= "</table><br>";
...
/****************************************************************************************************************/
	...
	$msg_site .= "<tr>";
    $msg_site .= "<td align=center colspan=5><b>SESMT - Serviços Especializados de Segurança de Monitoramento de Atividades no Trabalho LTDA<p>Prontuário Médico</b></td>";
    $msg_site .= "</tr>";
	$msg_site .= "<tr>";
    ...
    $msg_site .= "</tr>";
	$msg_site .= "<tr>";
    $msg_site .= "<td align=justify width=20%><b>Sexo:</b> </td>";
...
/****************************************************************************************************************/
    ...
    $msg_cliente .= "<tr>";
    $msg_cliente .= "<td align=center><b>ENCAMINHAMENTO MÉDICO COMPLEMENTAR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nº ".str_pad($count2[0]['id'], 4,"0",STR_PAD_LEFT)."</b></td>";
    $msg_cliente .= "</tr>";
	...
	$msg_cliente .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_cliente .= "<tr>";
    $msg_cliente .= "<td align=justify width=30%><b>Assunto:</b> Atendimento para</td>";
    $msg_cliente .= "</tr>";
    $msg_cliente .= "</table>";
...
/****************************************************************************************************************/
    ...
    $msg_cliente .= "</tr>";
	$msg_cliente .= "<tr>";
    $msg_cliente .= "<td align=justify width=20%><b>Sexo:</b> </td>";
    ...
    $msg_cliente .= "</tr>";
	$msg_cliente .= "<tr>";
    $msg_cliente .= "<td align=justify colspan=2><b>Obs: ____________________________________________________________________________________________________________________________________________</b></td>";
    $msg_cliente .= "</tr>";
    $msg_cliente .= "</table><br>";
    ...
    $msg_cliente .= "</tr>";
	$msg_cliente .= "<tr>";
    $msg_cliente .= "<td align=justify colspan=4><b>Obs: ____________________________________________________________________________________________________________________________________________</b></td>";
    $msg_cliente .= "</tr>";
    $msg_cliente .= "</table><br>";
...
/************************************************************************************************/
	...
	$msg_medico .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_medico .= "<tr>";
    $msg_medico .= "<td align=justify width=30%><b>Assunto:</b> Atendimento para</td>";
    $msg_medico .= "</tr>";
    $msg_medico .= "</table><br>";
...
/************************************************************************************************/
	...
	$msg_clinica .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_clinica .= "<tr>";
    $msg_clinica .= "<td align=justify width=30%><b>Assunto:</b> Atendimento para</td>";
    $msg_clinica .= "</tr>";
    $msg_clinica .= "</table><br>";
...
/************************************************************************************************/
    ...
    $msg_financeiro .= "<tr>";
    $msg_financeiro .= "<td align=center><b>ENCAMINHAMENTO MÉDICO COMPLEMENTAR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nº ".str_pad($count2[0]['id'], 4,"0",STR_PAD_LEFT)."</b></td>";
    $msg_financeiro .= "</tr>";
	...
	$msg_financeiro .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $msg_financeiro .= "<tr>";
    $msg_financeiro .= "<td align=justify width=30%><b>Assunto:</b> Atendimento para</td>";
    $msg_financeiro .= "</tr>";
    $msg_financeiro .= "</table><br>";
