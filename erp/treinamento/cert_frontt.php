...
$pdf->Image('ass.jpg',130,113,100,45);
  ...
  <table width="950" border="0">
    <tr>
      ...
      <td valign="bottom" align="center" class="style2"><div style="position: relative;"><img src="<?php echo $ass; ?>" border=0></div><BR>______________________________<br /><b>Coordenador</b></td>
	  <td width="250">&nbsp;</td>
    </tr>
  </table>
  <p>&nbsp;</p>
