<?PHP
    ...
    echo "<p>";
    echo "<center><font size=2>Certificado da empresa: <a href='cert_pdf_front_empresa.php?".$_SERVER[QUERY_STRING]."&tid={$bt[0][id]}' target=_blank class=fontebranca12><b>Frente</b></a> | <a href='cert_pdf_back_empresa.php?".$_SERVER[QUERY_STRING]."&tid={$bt[0][id]}' target=_blank class=fontebranca12><b>Verso</b></a></font></center>";
    echo "<P>";
    ...
    echo "<P>";
        ...
        echo "</tr>";
            for($x=0;$x<pg_num_rows($r);$x++){
                ...
                <a href='cert_front.php?".$_SERVER[QUERY_STRING]."&tid={$bt[$x][id]}' target=_blank class=fontebranca12><b>Frente</b></a> |
                <a href='cert_back.php?".$_SERVER[QUERY_STRING]."&tid={$bt[$x][id]}' target=_blank class=fontebranca12><b>Verso</b></a>
                </td>";
            }
        echo "</table>";
        }else{
