...
<tr>
    <td class=style9 align=left colspan=2 width=45%><b>Aluno(ª):</b></span> <?PHP echo $func[nome_func];?></td>
    <td class=style9 align=left colspan=1 width=170><b>CTPS:</b></span> <?PHP echo $func[num_ctps_func];?> <b>Série:</b></span> <?PHP echo $func[serie_ctps_func];?></td>
    <td class=style9 align=left colspan=1><b>Função:</b></span> <?PHP echo $funcao[nome_funcao];?></td>
</tr>
<tr>
