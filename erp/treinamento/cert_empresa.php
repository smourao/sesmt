...
$pdf->Cell(0,0,'CONTRATO: '.STR_PAD($tmp[1], 4, "0",0).'',0,0,'C');
$pdf->Ln(4);
$pdf->Ln(4);
...
<b>'.$tr[$x][cnpj].'</b>, está cumprindo a legislação 6.514/77,
conforme sua Port. 3.214/78 e suas Nrs 7 e 9. Mantendo os Programas e Relatórios atualizados,
em arquivo físico a disposição das autoridades por manter contrato com a empresa
SESMT - Serviços Especializados de Segurança e Monitoramento de Atividades no Trabalho Ltda,
...
$pdf->Image('../img/ass_pedro2.jpg',15,105,90,50);
$pdf->Cell(100,0,'SESMT - Segurança do Trabalho e Higiene Ocupacional',0,0,'C');
$pdf->Cell(20,0,' ',0,0,'C');
$pdf->Cell(100,0,ltrim(rtrim($tr[$x][razao_social])),0,0,'C');
$pdf->Ln(4);
$pdf->Cell(100,0,'CNPJ: 04.722.348/0001-17',0,0,'C');
$pdf->Cell(20,0,' ',0,0,'C');
$pdf->Cell(100,0,'CNPJ: '.$tr[$x][cnpj],0,0,'C');
