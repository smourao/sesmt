/* ********************************************************************
 **********************************************************************
 * HTML Virtual Keyboard Interface Script - v1.12
...
function VKI_buildKeyboardInputs() {
  ...
  this.VKI_version = " - SESMT";
  this.VKI_target = this.VKI_visible = "";
  this.VKI_shift = this.VKI_capslock = this.VKI_alternate = this.VKI_dead = false;
  this.VKI_deadkeysOn = true;
  this.VKI_kt = "Portuguese";//"US Int'l";  // Default keyboard layout
      ...
      for (var y = 0, keyid = "", ex; ex = elem[y++];) {
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
          ...
          var keybut = document.createElement('img');
              ...
              keybut.alt = "Teclado Virtual";
              keybut.className = "keyboardInputInitiator";
              keybut.title = "Exibir teclado virtual";
              keybut.onclick = (function(a) { return function() { self.VKI_show(a); }; })(keyid);

          var loca = document.getElementById('UcLogin1_btnLogin');

          ex.parentNode.insertBefore(keybut, loca.nextSibling); //ex.nextSibling);
    ...
    var tr = document.createElement('tr');
      ...
      var td = document.createElement('td');
        var clearer = document.createElement('span');
            ...
            clearer.title = "Limpar dados digitados";
        ...
        var tbody = document.createElement('tbody');
          ...
          for (var y = 0, lkey; lkey = lyt[y++];) {
            ...
            var td = document.createElement('td');
              ...
              if (lkey[0] == " ")
                td.style.paddingLeft = td.style.paddingRight = "45px";
