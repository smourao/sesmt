...
$sql = "SELECT * FROM produtos WHERE LOWER(categoria) LIKE '%".strtolower($_GET[cat])."%'";
$res = pg_query($sql);
...
$sql = "SELECT * FROM loja_medidas WHERE lower(categoria) LIKE '%".strtolower($_GET[cat])."%'";
$rrr = pg_query($sql);
...
$sql = "SELECT * FROM loja_legendas WHERE lower(categoria) LIKE '%".strtolower($_GET[cat])."%'";
$rle = pg_query($sql);
