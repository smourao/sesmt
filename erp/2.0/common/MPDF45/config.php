...
$this->header_line_spacing = 0;//0.25;	// spacing between bottom of header and line (if present) - function of fontsize
$this->footer_line_spacing = 0;//0.25;	// spacing between bottom of header and line (if present) - function of fontsize
...
$this->setAutoTopMargin = 'stretch';//true;//false
$this->setAutoBottomMargin = true;	//false
