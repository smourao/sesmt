...
<center><b>Incluir Foto do Posto de Trabalho</b></center>
<br>
<?PHP
//SE ENVIAR
...
<script>
window.close();
window.opener.document.getElementById(\"pic\").value = \"images/cgrt_apgre/{$filename}\";
window.opener.document.getElementById(\"foto\").innerHTML = \"<img src='images/cgrt_apgre/{$filename}' border=0 width=100 height=120>\";
</script>";
...
?>
<center>Selecione uma foto e clique em enviar para adicioná-la ao setor da empresa.
<form enctype="multipart/form-data" name="add" id="add" method="post" action="ajax_upload_apgre_pic.php?a=2">
