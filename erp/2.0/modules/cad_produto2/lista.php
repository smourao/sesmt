...
if(ceil($nitems/$rpp)>=5){
    ...
    echo " <div style=\"display: inline;\">";
        ...
        echo "<input type=button value='Ir' style=\"height: 16px; width: 20px; font-size: 10px;\" onclick=\"location.href='?dir=cad_produto2&p=index&sp=lista&page='+document.getElementById('topagenum').value;\">";
        echo "</td></tr></table>";
        echo "</div>";
    echo "</div>";
}elseif(($nitems/$rpp)<=1){
