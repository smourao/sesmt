...
$grauderiscosql = "SELECT grau_de_risco FROM cliente WHERE cliente_id = {$_GET[cod_cliente]}";
$grauderiscoquery = pg_query($grauderiscosql);
$grauderiscoarray = pg_fetch_array($grauderiscoquery);
$grauderisco = $grauderiscoarray[grau_de_risco];
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
		...
		echo "Grau de Risco: ".$grauderisco;
		echo "</td>";
        echo "</tr>";
        echo "</table>";
