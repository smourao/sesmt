...
if(is_numeric($_GET[cod_prod])){
    ...
    if($_POST[btnSaveProd] && $_POST){
        ...
        $sql = "UPDATE produto SET desc_resumida_prod = '".addslashes($_POST[desc_res])."',
    ...
    $sql = "SELECT MAX(cod_prod)+1 as cod_prod FROM produto";
    $res = @pg_query($sql);
    $prod = @pg_fetch_array($res);
    ...
    if($_POST[btnSaveProd] && $_POST){
        ...
        if(empty($_POST[desc_res]) || empty($_POST[desc_det])){
            ...
            $sql = "INSERT INTO produto (cod_prod, desc_resumida_prod, desc_detalhada_prod,
			...
			$gmaxx = 0;	
					...
					$sqll = "INSERT INTO produto (cod_prod, desc_resumida_prod, desc_detalhada_prod,
