<?PHP
if($_POST[nome] != ""){
	$query_alterar = "UPDATE parede SET 
						nome_parede 	 = '$nome'
						, decicao_parede = '$descricao'
						WHERE cod_parede = ".$cod_parede;
	if(pg_query($connect, $query_alterar)){	
	     showmessage('Parede Alterado com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<tr>";
        echo "<td align=center class='text roundborderselected'><b>Alterar Parede</b></td>";
        echo "</tr>";
        echo "</table>";
        ...
        echo "<td align=left width=200><input id='nome' type='text' name='nome' value='{$row[nome_parede]}' size='10' ></td>";
        echo "</tr>";

		echo "<tr class='text roundbordermix'>";
		echo "<td height=50 align=left class='text'><b>Descrição:</b></td>";
		echo "<td align=left><textarea cols=40 rows=3 id='descricao' type='text' name='descricao' size=40 >{$row[decicao_parede]}</textarea></td>";
		echo "</tr>";
