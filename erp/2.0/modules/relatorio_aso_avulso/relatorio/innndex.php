...
//**************************************************************************/	
	...
	for($c=0;$c<pg_num_rows($queryentrada);$c++){
		...
		$code .= "<tr><td align=center>".$entrada[$c][cod_fatura]."</td><td>".$br_data2."</td><td>".$tituloentrada."</td><td>".$entrada[$c][historico]."</td><td>R$ ".number_format($entrada[$c][valor], 2, ',','.')."</td></tr>";
	}
