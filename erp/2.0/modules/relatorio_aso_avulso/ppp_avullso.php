...
if($_GET[ppplist]){
	...
	if($_GET['nome_func'] && $_GET['razao_social'] ){
    ...
    if($_GET[ppplist]){
		...
		<form action="?dir=relatorio_aso_avulso&p=index&ppplist=true&razao_social=<?php $_POST['razao_social'] ?>&nome_func=<?php $_POST['nome_func'] ?>" id="frm" method="post">
