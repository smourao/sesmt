<?PHP
if($_POST[hidra] != ""){
	$query_incluir="INSERT into tipo_hidrante (tipo_hidrante, descricao) values ('$_POST[hidra]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Tipo de Hidrante Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Tipo de Hidrante:</b></td>";
        echo "<td align=left width=200><input id='hidra' type='text' name='hidra' size=40></td>";
        echo "</tr>";
