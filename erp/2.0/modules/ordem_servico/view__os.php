        ...
        switch($_GET[s]){
            case  0:
                if($st[status] != 0){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Aberta em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
            ...
            case  1:
                if($st[status] != 1){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Finalizada em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
            ...
            case  2:
                if($st[status] != 2){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Em Execução em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
            ...
            case  3:
                if($st[status] != 3){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Cancelada em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
            ...
            case  4:
                if($st[status] != 4){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Excluída em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
            ...
            case  5:
                if($st[status] != 5){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Pendente em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
