        ...
        echo "<br>";
		 ...
		 echo "<table width=100% border=0 cellspacing=2 cellpadding=2>";
            ...
            echo "<tr>";
				...
				echo "<td width=7% align=center class='text'>";
				...
				echo "<td width=6% align=center class='text'>";
			...
			echo "<tr>";
				...
				$dia_vencimento = date('d/m', strtotime($os_info[$x]['data_conclusao']));
				
				$data_vencimento = date('Y-m-d', strtotime($os_info[$x]['data_conclusao']));
				
			if(($os_info[$x][status] == 0) || ($os_info[$x][status] == 2) || ($os_info[$x][status] == 3)){
				
				
				if($os_info[$x]['data_conclusao'] == ''){
					
					$bg_dia_vencimento = '';
					
				}elseif($data_vencimento == $diadehoje){
				
					$bg_dia_vencimento = '#19cb72';
				
				}elseif($data_vencimento < $diadehoje){
					
					$bg_dia_vencimento = '#66000c';
				...
				echo "<td align=center class='text roundbordermix curhand' bgcolor='".$bg_dia_vencimento."'>";
