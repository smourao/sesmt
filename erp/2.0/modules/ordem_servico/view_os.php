...
$sql = "SELECT i.*, s.nome_setor FROM os_info i, setor_sesmt s
        ...
        switch($_GET[s]){
            case  0:
                if($st[status] != 0){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Aberta em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.<br><br> Com a mensagem: <b>".nl2br($info['msg'])."</b>.";
            ...
            case  1:
                if($st[status] != 1){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Finalizada em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.<br><br> Com a mensagem: <b>".nl2br($info['msg'])."</b>.";
            ...
            case  2:
                if($st[status] != 2){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Em Execução em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.<br><br> Com a mensagem: <b>".nl2br($info['msg'])."</b>.";
            ...
            case  3:
                if($st[status] != 3){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Cancelada em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.<br><br> Com a mensagem: <b>".nl2br($info['msg'])."</b>.";
            ...
            case  4:
                if($st[status] != 4){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Excluída em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.<br><br> Com a mensagem: <b>".nl2br($info['msg'])."</b>.";
            ...
            case  5:
                if($st[status] != 5){
					...
					$mensagem = "O <b>{$cadcria[nome]}</b> marcou a O.S.: <b>{$_GET[os]}</b> como Pendente em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.<br><br> Com a mensagem: <b>".nl2br($info['msg'])."</b>.";
  ...
  <tr>
	...
	if($_POST){
		...
		$mensagem = "O <b>{$cadcria[nome]}</b> respondeu a sua mensagem na O.S.: <b>{$_GET[os]}</b> em ".date("d/m/Y H:i")." Com o assunto: <b>".$info['assunto']."</b>.";
