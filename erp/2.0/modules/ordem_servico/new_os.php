    ...
    if(!$_POST){
        ...
        echo "<table width=100% border=0 cellspacing=2 cellpadding=2>";
            ...
            echo "<tr>";
				...
				echo "<option value=1>Alta</option><option value=2 selected>Média</option><option value=3>Baixa</option></select>";
			...
			echo "<tr>";
				...
				echo "<b>Previsão Término:</b>";
				
                echo "</td>";
				
				echo "<td class='text'>";

				echo "<input type=text size=10 maxlength=10 name=data_termino id=data_termino onkeypress=\"formatar(this, '##/##/####');\"> <font size=1>(Caso não haja previsão de término, deixe em branco)</font>";
            ...
            <table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
            	<tr>
            		<td width=\"70%\" align=\"center\" class=\"fontepreta12\"><br />
            		  ...
            		  <p align=justify>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Uma nova O.S. foi gerada no sistema com o título: <b>{$_POST[assunto]}</b> em ".date("d/m/Y H:i").". Com a mensagem: <b> ".$msg."</b>
            <p align=left>
            <p>
            <br></span>
                       </td>
  ...
  <tr>
    ...
    <b> Telefone: +55 (21) 3014 4304 &nbsp; Fax: Ramal 7<br>
     ...
     Pensando em<br>renovar seus<br>programas?<br>Fale primeiro<br>com a gente!</b>
            ...
            mail($manda_email, 'Abertura de Ordem de Serviço Nº '.STR_PAD($max, 4, "0", STR_PAD_LEFT)."/".date("Y"), $msg, $headers);
