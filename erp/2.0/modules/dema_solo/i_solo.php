<?PHP
if($_POST[solo] != ""){
	$query_incluir="INSERT into demarcacao_solo (demarcacao_solo, descricao) values ('$_POST[solo]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Demarcação de Solo Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Solo:</b></td>";
        echo "<td align=left width=200><input id='solo' type='text' name='solo' size=40></td>";
        echo "</tr>";
