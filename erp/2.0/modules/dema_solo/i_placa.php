<?PHP
if($_POST[placa] != ""){
	$query_incluir="INSERT into placa_sinalizacao (placa_sinalizacao, descricao) values ('$_POST[placa]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Placa de Sinalização Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<tr>";
        echo "<td align=center class='text roundborderselected'><b>Placa de Sinalização</b></td>";
        echo "</tr>";
        echo "</table>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Placa:</b></td>";
        echo "<td align=left width=200><input id='placa' type='text' name='placa' size=40></td>";
        echo "</tr>";

		echo "<tr class='text roundbordermix'>";
		echo "<td height=100 align=left class='text'><b>Descrição:</b></td>";
