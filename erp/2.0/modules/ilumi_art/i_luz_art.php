...
if($_POST[artificial] != ""){
	...
	$cod_luz_art = $row_max[cod_luz_art] + 1;
	
	$query_incluir="INSERT into luz_artificial (cod_luz_art, nome_luz_art, decricao_luz_art) values ($cod_luz_art, '$_POST[artificial]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){	
	     showmessage('Iluminação Artificial Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td align=left width=200><input id='artificial' type='text' name='artificial' size='10' >
			  <input name=cod_luz_art type=hidden id=cod_luz_art value=$row_max[cod_luz_art]></td>";
        echo "</tr>";
