<?PHP
if($_POST[artificial] != ""){
	$query_alterar = "UPDATE luz_artificial SET 
						nome_luz_art 	   = '$artificial'
						, decricao_luz_art = '$descricao'
						WHERE cod_luz_art  = ".$cod_luz_art;
	if(pg_query($connect, $query_alterar)){	
	     showmessage('Iluminação Artificial Alterado com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<tr>";
        echo "<td align=center class='text roundborderselected'><b>Alterar Iluminação Artificial</b></td>";
        echo "</tr>";
        echo "</table>";
        ...
        echo "<td align=left width=200><input id='artificial' type='text' name='artificial' value='{$row[nome_luz_art]}' size='10' ></td>";
        echo "</tr>";

		echo "<tr class='text roundbordermix'>";
		echo "<td height=50 align=left class='text'><b>Descrição:</b></td>";
		echo "<td align=left><textarea cols=40 rows=3 id='descricao' type='text' name='descricao' size=40 >{$row[decricao_luz_art]}</textarea></td>";
		echo "</tr>";
