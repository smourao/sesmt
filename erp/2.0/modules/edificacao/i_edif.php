<?PHP
if($_POST[edificacao] != ""){
	$query_incluir="INSERT into tipo_edificacao (tipo_edificacao, descricao) values ('$_POST[edificacao]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Edificação Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td align=left width=200><input id='edificacao' type='text' name='edificacao' size='10' ></td>";
        echo "</tr>";
