...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="50%" align="left"><img src="../../../images/logo_sesmt_aso_final.png" width="333" height="175" /></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		...
		if( !empty($funcionario) and !empty($aso) ){
			$query_exame="SELECT e.cod_exame, e.especialidade, s.data_agendamento
						  FROM exame e, aso a, site_aso_agendamento s, funcionarios f, cliente c
						  WHERE a.cod_aso = ae.cod_aso
						  AND e.cod_exame = s.exames
						  AND a.cod_func = f.cod_func 
						  AND c.cliente_id = f.cod_cliente
						  ...
						  AND s.status = 1 order by especialidade";
			...
			echo "<Table border=0 width=100%>";			
				while($row_exame=pg_fetch_array($result_exame)){ 
					...
					echo "</td><td align=\"left\" class='fontepreta12 style1'>";
						echo date("d/m/Y", strtotime($row_exame[data_agendamento]));
					echo "</td></tr>";
				}
				echo "</table>";
			echo "	</td>";
...
<p>
	<tr>
		...
		<td width="35%" align="right"><img src="../../../images/logo_sesmt2_aso_final.png" width="280" height="200" /></td>
	</tr>
</table>
</td>
</tr>
