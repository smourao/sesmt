...
if (!empty($funcionario) and !empty($aso)){
        $query_func = "SELECT f.cod_func, f.nome_func, f.num_ctps_func, f.serie_ctps_func, f.cbo, f.dinamica_funcao, f.rg, f.cpf -- funcionário
...
/****************************************************************************************************************/
    ...
    $code .= "<td width=20% class='text'><b>Função:</b></td>";
	...
	$code .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $code .= "<tr>";	
	$code .= "<td width=50% class='text'><b>Classificação da Atividade:</b></td>";
    $code .= "<td width=50% class='text'><b>Nível de Tolerância:</b></td>";
    $code .= "</tr>";
	$code .= "<tr>";	
