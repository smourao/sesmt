<?PHP
if($_POST[raio] != ""){
	$query_incluir="INSERT into tipo_para_raio (tipo_para_raio, descricao) values ('$_POST[raio]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Tipo de Para-raio Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Para-raio:</b></td>";
        echo "<td align=left width=200><input id='raio' type='text' name='raio' size=40></td>";
        echo "</tr>";
