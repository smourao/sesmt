<?PHP
if($_POST[inc] != ""){
	$query_incluir="INSERT into alarme_contra_incendio (alarme_contra_incendio, descricao) values ('$_POST[inc]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Alarme Contra Incêndio Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Alarme:</b></td>";
        echo "<td align=left width=200><input id='inc' type='text' name='inc' size=40></td>";
        echo "</tr>";
