...
/*****************************************************************************************************************/
//Cliente info
$sql = "SELECT s.*, c.*, cnae.* FROM site_orc_info s, cliente c, cnae cnae WHERE s.cod_orcamento = $cod_orcamento AND s.cod_cliente = c.cliente_id AND c.cnae_id = cnae.cnae_id";
$rci = pg_query($sql);
...
/****************************************************************************************************************/
	...
	//$code .= "<tr>";
	//$code .= "<td align=right><b>Orçamento:</b> {$info[cod_orcamento]}</td>";
	//$code .= "</tr>";
    $code .= "<tr>";
...
/****************************************************************************************************************/
	...
	if($db[nome_aparelho] != ""){
		...
		$code .= "<b>Data de Calibração:</b> ".date("d/m/Y", strtotime($db[data_criacao]))."<p>";
    }else{
		$code .= "<br>";
	}
	...
	if($temp[nome_aparelho] != ""){
		...
		$code .= "<b>Data de Calibração:</b> ".date("d/m/Y", strtotime($temp[data_criacao]))."<p>";
    }else{
		$code .= "<br>";
	}
	...
	if($ilu[nome_aparelho] != ""){
		...
		$code .= "<b>Data de Calibração:</b> ".date("d/m/Y", strtotime($ilu[data]))."<p align=justify>";
    }else{
		$code .= "<br>";
	}
