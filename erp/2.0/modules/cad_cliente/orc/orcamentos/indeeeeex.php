...
ob_start();
    ...
    if($_GET[sem_timbre]){
		...
		<tr>
			<td align="left">
            <p><strong>
            <span id=sesmt><font size="8" face="Verdana, Arial, Helvetica, sans-serif"><h1>SESMT</span><span style="position: relative;top:-15px;"><sup><font size=1>®</h1></font></sup></font></span>&nbsp;&nbsp;
			<font face="Verdana, Arial, Helvetica, sans-serif">SERVIÇOS ESPECIALIZADOS DE SEGURANÇA<br> E MONITORAMENTO DE ATIVIDADES NO TRABALHO<br>
    ...
    if($_GET[sem_timbre]){
        ...
        $rodape .= "<table width=100% border=0 cellspacing=0 cellpadding=0 height=$footer_h>";
        $rodape .= "<tr>";
        $rodape .= "<td align=left height=$footer_h valign=bottom class='medText'>Telefone: +55 (21) 3014 4304      Fax: Ramal 7<br>Nextel: +55 (21) 7844 9394 / Id 55*23*31368<br>comercial@sesmt-rio.com<br>www.sesmt-rio.com / www.shoppingsesmt.com</td>";
