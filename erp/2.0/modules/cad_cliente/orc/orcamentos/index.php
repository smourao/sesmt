...
/****************************************************************************************************************/
	...
	$code .= "<h3 style=margin-top:-30px>Empresa Especialista em SST Segurança e Saúde do Trabalho no eSocial</h3><br>";
	...
	for($q=0;$q<count($pl);$q++){
        if(in_array($pl[$q], $_BRIGADA)){
			...
			if($bombnivel3 == 1){
				...
				$code .= "<td align=justify bgcolor='#EEEEEE'>&nbsp;Auditório para aula teórica.</td>";
