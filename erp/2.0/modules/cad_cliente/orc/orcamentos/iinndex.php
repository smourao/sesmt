...
ob_start();
    ...
    if($_GET[sem_timbre]){
        ...
        $rodape .= "<table width=100% border=0 cellspacing=0 cellpadding=0 height=$footer_h>";
        $rodape .= "<tr>";
        $rodape .= "<td align=left height=$footer_h valign=bottom class='medText'><h3>Telefone: +55 (21) 3014 4304      Fax: Ramal 7<br>Nextel: +55 (21) 7844 9394 / Id 55*23*31368<br>comercial@sesmt-rio.com<br>www.sesmt-rio.com</h3></td>";
