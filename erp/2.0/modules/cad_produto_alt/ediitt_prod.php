...
if(is_numeric($_GET[cod_prod])){
    ...
    if($_POST[btnSaveProd] && $_POST){
        ...
        cod_chave = '".addslashes($_POST[cod_chave])."', g_min = $gmin, g_max = $gmax, cod_atividade = $_POST[atividade]
    ...
    if($_POST[btnSaveProd] && $_POST){
        ...
        if(empty($_POST[desc_res]) || empty($_POST[desc_det])){
            ...
            '".addslashes($_POST[desc_det])."', '$price', $gmin, $gmax, $grauderisco, '".addslashes($_POST[cod_chave])."', $_POST[atividade])";
