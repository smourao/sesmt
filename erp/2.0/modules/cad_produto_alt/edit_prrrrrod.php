...
if(is_numeric($_GET[cod_prod])){
    ...
    if($_POST[btnSaveProd] && $_POST){
        ...
        if(empty($_POST[desc_res]) || empty($_POST[desc_det])){
            ...
            '".addslashes($_POST[desc_det])."', '$price', $_POST[gmin], $_POST[gmax], $_POST[graurisc], '".addslashes($_POST[cod_chave])."', $_POST[atividade])";
			...
			if(isset($_POST['numprod'])){
				...
				for($j=1;$j<$numrepetir;$j++){
            		...
            		'".addslashes($_POST[$varidesdeta])."', '$prices', $_POST[$varigmin], $_POST[$varigmax], $_POST[$varigraurisc], '".addslashes($_POST[$varicodchave])."', $_POST[$varicodativ])";
