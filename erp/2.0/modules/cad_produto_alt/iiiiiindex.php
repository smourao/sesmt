...
"UPDATE produto_alt
SET preco_custo = preco_prod * ".$porcen." WHERE tabela_produto = ".$tabelprod." AND cod_tipo = ".$codtipo."";
...
/**************************************************************************************************/
     echo "<td width=250 class='text roundborder' valign=top>";
                ...
                // --> TIPBOX
                echo "<table width=100% border=0 cellspacing=3 cellpadding=2 style='position: fixed'>";
                echo "<tr>";
