...
if($_GET[dupliall]){
 ...
 $sqlall = "SELECT * FROM produto_alt WHERE grau_risco = 1 ORDER BY cod_prod";
        $rtall = pg_query($sqlall);
		$arrayall = pg_fetch_array($rtall);
                ...
                echo "<tr>";
                    echo "<td class='roundbordermix text' height=30 align=left>";
                        ...
                        echo "<td class='text' align=center><input type='button' class='btn' name='button' value='Novo' onclick=\"location.href='?dir=$_GET[dir]&p=$_GET[p]&sp=edit_prod&page=$_GET[page]&cod_prod=new';\"  onmouseover=\"showtip('tipbox', '- Novo, permite o cadastro de um novo produto.');\" onmouseout=\"hidetip('tipbox');\"></td>";
						 echo "<td class='text' align=center><input type='button' class='btn' name='button' value='Duplicar Tabela' onclick=\"location.href='?dir=$_GET[dir]&p=$_GET[p]&dupliall=1';\"  onmouseover=\"showtip('tipbox', '- Duplicar, permite duplicar toda a tabela.');\" onmouseout=\"hidetip('tipbox');\"></td>";
                        echo "</tr>";
                        echo "</table>";
                    echo "</td>";
                echo "</tr>";
