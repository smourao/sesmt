			...
			if(isset($_POST['numprod'])){
				...
				for($j=1;$j<$numrepetir;$j++){
					...
					$sqll = "INSERT INTO produto_alt (cod_prod, desc_resumida_prod, desc_detalhada_prod,
           			preco_prod, cod_chave, cod_atividade) VALUES ($_POST[$varicodprod], '".addslashes($_POST[$varidescresu])."',
            		'".addslashes($_POST[$varidesdeta])."', '$prices', '".addslashes($_POST[$varicodchave])."', $_POST[$varicodativ])";
