         ...
         if(!$_GET[sp] || $_GET[sp] == 'lista'){
                ...
                echo "<tr>";
                    echo "<td class='roundbordermix text' height=30 align=left>";
						...
						<input type='button' class='btn' name='button' value='Novo' onclick=\"location.href='?dir=$_GET[dir]&p=$_GET[p]&sp=new';\"  onmouseover=\"showtip('tipbox', '- Novo ASO.');\" onmouseout=\"hidetip('tipbox');\"><p/>
