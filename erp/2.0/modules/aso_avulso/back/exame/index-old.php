...
/****************************************************************************************************************/
    ...
    $code .= "<tr>";
	$code .= "<td width=10% class='text'><b>Nº ASO:</b></td>";
	$code .= "<td width=10% class='text'><b>Cliente:</b></td>";
    $code .= "<td class='text'><b>Razão social:</b></td>";
    $code .= "</tr>";
	$code .= "<tr>";
    ...
    $code .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $code .= "<tr>";
	$code .= "<td width=55% class='text'><b>Endereço:</b></td>";
	...
	$code .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $code .= "<tr>";	
	$code .= "<td width=70% class='text'><b>Nome do Funcionário:</b></td>";
	if($row_func[num_ctps_func] != ""){
		$code .= "<td width=15% class='text'><b>CTPS:</b></td>";
		$code .= "<td class='text'><b>Série:</b></td>";
		$code .= "</tr>";
		$code .= "<tr>";
    ...
    $code .= "<td width=30% class='text'><b>Função:</b></td>";
	...
	$code .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $code .= "<tr>";	
	$code .= "<td width=50% class='text'><b>Classificação da Atividade:</b> $row_func[nome_atividade]</td>";
    $code .= "<td width=50% class='text'><b>Nível de Tolerância:</b> $row_func[nome]</td>";
    $code .= "</tr>";
	/*$code .= "<tr>";	
	...
	$code .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $code .= "<tr>";	
	$code .= "<td width=30% class='text'><b>Risco da Função:</b></td>";
    $code .= "<td width=30% class='text'><b>Riscos Específicados:</b></td>";
	...
	$code .= "<tr>";
	$code .= "<td class='text'><b>Data de Realização:&nbsp;</b>".date("d/m/Y", strtotime($row_func[aso_data]))."</td>";
    $code .= "</tr>";
	$code .= "</table>";
	$code .= "<table width=100% cellspacing=2 cellpadding=2 border=0>";
    $code .= "<tr>";	
	$code .= "<td align=center width=50% class='text' valign='bottom'>______________________________________</td>";
    $code .= "<td align=center width=50% class='text'>"; if(!$_GET[sem_timbre]){	$code .= "<img src='"._IMG_PATH."assinatura.png'/>"; } $code .= "</td>";
    $code .= "</tr>";
	$code .= "<tr>";	
	$code .= "<td align=center class='text'>Assinatura do Examinado</td>";
    $code .= "<td align=center class='text'>Assinatura do Examinador</td>";
    $code .= "</tr>";
	$code .= "</table>";
