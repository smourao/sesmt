...
if(!empty($_GET[a])){
	...
	setTimeout(\"location.href = '?dir=enc_avulso&p=index&sp=edit&aso=$_GET[aso]';\",0);
	</script>";
}
...
echo "<td align=center class='text roundborderselected'>";
    ...
    //FORM - SAVE DATA
    echo "<form method=post name=save action=?dir=enc_avulso&p=index&sp=edit&aso=$_GET[aso]&a=1 onsubmit=\"return validar(this);\">";
