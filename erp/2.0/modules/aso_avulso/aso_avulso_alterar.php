...
if (!empty($aso))
	...
	$result_busca = pg_query($query_busca);
...
if(!empty($aso) and $_POST[alterar]=="Alterar"){
	...
	if($result_func){
		echo '<script> alert("Os dados foram alterados com sucesso!");
		if(confirm)
...
<tr>
<td>
<form action="<?php "?dir=aso_avulso&p=index&sp=lista" ?>" name="frm_aso" method="post">
<div align="center">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="50%" align="left"><p align="center"><font color="#006633" face="Verdana, Arial, Helvetica, sans-serif"><span class="style2">Serviços Especializados de Segurança e <br>
	      ...
	      CREMERJ 52.33.471-0 Reg. MTE 13.320 </font></p><br /><br />
	    <p class="style2">		</td>
	</tr>
</table></div>
<div align="center">
