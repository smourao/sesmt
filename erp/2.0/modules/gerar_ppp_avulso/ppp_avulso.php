...
/***************************************************************************************************/
	$pppavulsosql = "SELECT id, razao_social, nome_func, data_lancamento, id_ppp FROM ppp_avulso ORDER BY id_ppp DESC";
...
/***************************************************************************************************/
    ...
    echo "<td align=left class='text'>";
		...
		<form action="http://sesmt-rio.com/erp/2.0/modules/gerar_ppp_avulso/insertppp.php" id="frm" method="post">
        ...
        echo "<table width=100% border=0 cellspacing=2 cellpadding=2>";
		 ...
		 echo "<table width=100% border=0 cellspacing=2 cellpadding=2>";
			...
			echo "<tr>";
				...
				echo "<td align=center class='text roundbordermix curhand' onclick=\"location.href='?dir=gerar_ppp_avulso&p=index&cadastro=true&id={$pppavulso[$x][id]}';\">";

                    echo $pppavulso[$x][id_ppp];
