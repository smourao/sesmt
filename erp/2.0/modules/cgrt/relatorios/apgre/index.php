...
/****************************************************************************************************************/
    ...
    $code .= "</tr><tr>";
    $code .= "<td>SESMT Serviços Especializados em Segurança e Monitoramentos de Atividades no Trabalho Ltda<br>Rua: George Bizet, 92 – Jardim América – Rio de Janeiro – RJ<br>CNPJ: 04.722.248/0001-17<br>&nbsp;</td>";
    $code .= "</tr><tr>";
...
/****************************************************************************************************************/
    ...
    $code .= "</tr><tr>";
    $code .= "<td>Identificação da análise<br>Descrição física e histórica<br>Descrição do método de trabalho<br>Descrição da população funcional<br>Análise pró-ativa de riscos ergonômicos<br>Considerações</td>";
    $code .= "</tr><tr>";
...
/****************************************************************************************************************/
	...
	$code .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Recomenda-se ainda, adotar o uso de telas de nylon para prevenir o acesso de insetos e poeira no ambiente de trabalho.<br>";
...
/****************************************************************************************************************/
	...
	$code .= "</tr>";
	$code .= "<tr>";
    $code .= "<td align=left width=25%><b>Histórico de Melhoria:</b></td>";
	$code .= "<td align=left width=75%>{$avl[$x][h_melhoria]}</td>";
	$code .= "</tr>";
	$code .= "<tr>";
    $code .= "<td align=left width=25%><b>Histórico de Acidentes:</b></td>";
	...
	$code .= "<tr>";
    $code .= "<td class='text' align=left><b>Ergonomia Risco Analisado</b></td>";
	$code .= "</tr>";
	$code .= "</table>";
	$code .= "<table width=100% cellspacing=0 cellpadding=0 border=1>";
	$code .= "<tr>";
	...
	$code .= "<table width=100% cellspacing=0 cellpadding=0 border=0>";
	$code .= "<tr>";
    $code .= "<td class='text' align=left><b>Aspectos Psicossociais</b></td>";
	$code .= "</tr>";
	$code .= "</table>";
	$code .= "<table width=100% cellspacing=0 cellpadding=0 border=1>";
	$code .= "<tr>";
...
/****************************************************************************************************************/
    ...
    $code .= "<BR><p><BR>";
    $code .= "<BR><p><BR>";
    $code .= "<center><div class='bigTitle'><b>EFEITOS<BR><BR>DA<BR><BR>ILUMINÂNCIA<BR></b></div></center>";
...
/****************************************************************************************************************/
	...
	$code .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As atividades quando desenvolvidas na empresa pelos funcionários do setor administrativo caracterizar-se por trabalho em pé e eventualmente sentado, de natureza moderada, com movimentos sequenciais, repetitivos em relação ao uso das mãos, pulsos e braços, com jornada de trabalho diurna.<br>";
