...
$quadro2 = "SELECT s.nome_setor, a.nome_agente_risco, a.num_agente_risco, a.cod_tipo_risco, t.nome, ca.nome as nome1, r.*
...
for($x=0;$x<pg_num_rows($ibut);$x++){
	...
	$ibutg = ( ( $ibu[$x][ibtug_t] * $ibu[$x][temperatura] ) + ( $ibu[$x][ibtug_d] * $ibu[$x][tempo_d] ) ) / 60;
	
	$code.= '<tr>
				<td align="center" class="fontepreta12" width="40%">'.$ibu[$x][nome_setor].'</td>
				<td align="center" class="fontepreta12" width="20%">'.$ibu[$x][temperatura].'</td>
...
$code .= '<table align="center" width="80%" height="$height" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
		...
		<tr>
			...
			<td align="center" class="fontepreta14bold"><img src="http://www.sesmt-rio.com/erp/2.0/images/assinaturas/4048135020_assrenatapb.png" border=0 width=300 height=130></td>
