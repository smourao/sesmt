...
$code .= '<table align="center" width="80%" height="$height" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
		...
		<tr>
			...
			<td align="center" class="fontepreta14bold">';
			if($info[id_resp_ppra] == 18){
				echo'<img src="../../../../images/ass_pedro3.png" border=0 width=300 height=130></td>';
			}else{
				echo'<img src="http://www.sesmt-rio.com/erp/2.0/images/assinaturas/4048135020_assrenatapbbb.png" border=0 width=300 height=130></td>';
			}
		echo '</tr>
		</table><p>
