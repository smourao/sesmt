<?PHP
if($_POST[nome] != ""){
	$query_incluir="INSERT into cargo (nome, descricao) values ('$_POST[nome]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Cargo Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Cargo:</b></td>";
        echo "<td align=left width=200><input id='nome' type='text' name='nome' size=40></td>";
        echo "</tr>";
