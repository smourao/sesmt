...
/**************************************************************************************************/
     echo "<td width=250 class='text roundborder' valign=top>";
                ...
                $sql = "SELECT DISTINCT(nome_contador), escritorio_contador, email_contador, tel_contador FROM cliente WHERE TRIM(nome_contador) <> '' AND tel_contador not like '00%' AND tel_contador != '' AND tel_contador != '-' AND tel_contador not like '21 - 00%' AND tel_contador !='0' ORDER BY nome_contador DESC";
                $rtotal = pg_query($sql);
