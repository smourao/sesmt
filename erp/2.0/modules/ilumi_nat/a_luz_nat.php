<?PHP
if($_POST[natural] != ""){
	$query_alterar = "UPDATE luz_natural SET 
						nome_luz_nat 		= '$natural'
						, descricao_luz_nat = '$descricao'
						WHERE cod_luz_nat 	= ".$cod_luz_nat;
	if(pg_query($connect, $query_alterar)){	
	     showmessage('Iluminação Natural Alterado com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<tr>";
        echo "<td align=center class='text roundborderselected'><b>Alterar Iluminação Natural</b></td>";
        echo "</tr>";
        echo "</table>";
        ...
        echo "<td align=left width=200><input id='natural' type='text' name='natural' value='{$row[nome_luz_nat]}' size='10' ></td>";
        echo "</tr>";

		echo "<tr class='text roundbordermix'>";
		echo "<td height=50 align=left class='text'><b>Descrição:</b></td>";
		echo "<td align=left><textarea cols=40 rows=3 id='descricao' type='text' name='descricao' size=40 >{$row[descricao_luz_nat]}</textarea></td>";
		echo "</tr>";
