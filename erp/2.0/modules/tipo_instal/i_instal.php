<?PHP
if($_POST[tipo] != ""){
	$query_incluir="INSERT into tipo_instalacao (tipo_instalacao, descricao) values ('$_POST[tipo]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Tipo de Instalação de Extintor Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Tipo de Instalação:</b></td>";
        echo "<td align=left width=200><input id='tipo' type='text' name='tipo' size=40></td>";
        echo "</tr>";
