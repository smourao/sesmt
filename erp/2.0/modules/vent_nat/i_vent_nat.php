...
if($_POST[natural] != ""){
	...
	$cod_vent_nat = $row_max[cod_vent_nat] + 1;
	
	$query_incluir="INSERT into ventilacao_natural (cod_vent_nat, nome_vent_nat, decricao_vent_nat) values ($cod_vent_nat, '$_POST[natural]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){	
	     showmessage('Ventilação Natural Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td align=left width=200><input id='natural' type='text' name='natural' size='10' >
			  <input name=cod_vent_nat type=hidden id=cod_vent_nat value=$row_max[cod_vent_nat]></td>";
        echo "</tr>";
