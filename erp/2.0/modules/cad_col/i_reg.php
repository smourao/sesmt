...
if($_POST[nome] != ""){
	...
	$query_incluir="INSERT INTO funcionario 
					...
					VALUES 
					($funcionario_id, $cargo_id, 1, $grupo_id, '".addslashes($_POST[nome])."', '$cpf', '$ctps', '$telefone', '$celular', '$email',
...
/**************************************************************************************************/
        ...
        echo "<td align=left width=220><input class=inputTextobr id='telefone' type='text' name='telefone' size='35' maxlength='12' OnKeyPress=\"formatar(this, '##-#### ####');\"></td>";
        echo "<td align=left class='text' width=100><b>Celular:</b></td>";
        echo "<td align=left class='text' width=220><input id='celular' type='text' name='celular' size='35' maxlength='12' OnKeyPress=\"formatar(this, '##-#### ####');\"></td>";
        echo "</tr>";
        ...
        echo "<td align=left width=220><input id='ctps' type='text' name='ctps' size='35' ></td>";
        echo "<td align=left class='text' width=100><b>Serie:</b></td>";
        echo "<td align=left class='text' width=220><input id='serie' type='text' name='serie' size='35' ></td>";
        echo "</tr>";

        echo "<tr>";
		echo "<td align=left class='text' width=100><b>RG:</b></td>";
        echo "<td align=left width=220><input id='ident' type='text' name='ident' size='35' maxlength='10' OnKeyPress=\"formatar(this, '########-#');\"></td>";
        ...
        echo "<td align=left width=220><input id='titulo' type='text' name='titulo' size='35' ></td>";
        echo "<td align=left class='text' width=100><b>Zona eleitoral:</b></td>";
        echo "<td align=left class='text' width=220><input id='zona' type='text' name='zona' size='35' ></td>";
        echo "</tr>";

        echo "<tr>";
		echo "<td align=left class='text' width=100><b>Cert. reservista:</b></td>";
        echo "<td align=left width=220><input id='reserva' type='text' name='reserva' size='35' ></td>";
        echo "<td align=left class='text' width=100><b>Nascimento:</b></td>";
        echo "<td align=left class='text' width=220><input id='dtn' type='text' name='dtn' size='35' maxlength=10 onkeypress=\"formatar(this, '##/##/####');\" ></td>";
        echo "</tr>";
        ...
        echo "<td align=left class='text' width=220><input id='endereco' type='text' name='endereco' size='25' >&nbsp;<input id='num' type='text' name='num' size='3' ></td>";
        echo "</tr>";
        ...
        echo "<td align=left width=220><select class=inputTextobr name=cargo_id id=cargo_id style=\"width: 245px\">
        ...
        echo "<td align=left width=220><select class=inputTextobr name=grupo_id id=grupo_id style=\"width: 245px\">
        ...
        echo "<td align=left class='text' width=220><input class='' id='login' type='text' name='login' value='{$row[login]}' size='35'></td>";
        echo "<td align=left class='text' width=100><b>Senha:</b></td>";
        echo "<td align=left class='text' width=220><input class='' id='senha' type='text' name='senha' value='{$row[senha]}' size='35' ></td>";
        echo "</tr>";
