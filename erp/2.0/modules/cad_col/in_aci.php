...
/**************************************************************************************************/
     echo "<td width=250 class='text roundborder' valign=top>";
                ...
                echo "<table width=100% border=0 cellspacing=3 cellpadding=2>";
                echo "<tr>";
				echo "<td class='text' align=center><input type='button' class='btn' name='btnAlt' value='Incluir' onclick=\"location.href='?dir=cad_col&p=a_reg&funcionario_id=$_GET[funcionario_id]&p=al_aci';\"  onmouseover=\"showtip('tipbox', '- Permite incluir/alterar o acidente do colaborador da SESMT.');\" onmouseout=\"hidetip('tipbox');\"></td>";
				echo "</tr>";
				echo "</table>";
...
/**************************************************************************************************/
	...
	$list = pg_fetch_all($result_func);
        ...
        for($i=0;$i<pg_num_rows($result_func);$i++){
            ...
            echo "<td align=center class='text roundborder '><a href='?dir=cad_col&p=a_reg&remove={$list[$i]['id']}&p=in_aci' >Excluir</a></td>";
            echo "</tr>";
        }
        echo "</table>";
