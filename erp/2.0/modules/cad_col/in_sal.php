...
showmessage('Salário do Colaborador Excluido com Sucesso!');
}
/***************************************************************************************************/
// --> VARIABLES
/***************************************************************************************************/
...
/**************************************************************************************************/
     echo "<td width=250 class='text roundborder' valign=top>";
                ...
                echo "<table width=100% border=0 cellspacing=3 cellpadding=2>";
                echo "<tr>";
				echo "<td class='text' align=center><input type='button' class='btn' name='btnAlt' value='Incluir' onclick=\"location.href='?dir=cad_col&funcionario_id=$_GET[funcionario_id]&p=al_sal';\"  onmouseover=\"showtip('tipbox', '- Permite incluir/alterar o salário do colaborador da SESMT.');\" onmouseout=\"hidetip('tipbox');\"></td>";
				echo "</tr>";
				echo "</table>";
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        echo "<table width=100% border=0 cellspacing=2 cellpadding=2>";
        echo "<tr>";
        echo "<td align=center class='text roundborderselected'><b>Alteração de Salário</b></td>";
        echo "</tr>";
        echo "</table>";
	...
	$list = @pg_fetch_all($result_func);
		...
		echo "<td align=left class='text' width=300><b>Importância:</b></td>";
        ...
        for($i=0;$i<@pg_num_rows($result_func);$i++){
            ...
            echo "<td align=center class='text roundborder '><a href='?dir=cad_col&p=a_reg&remove={$list[$i]['id']}&p=in_sal&funcionario_id={$_GET[funcionario_id]}' >Excluir</a></td>";
            echo "</tr>";
        }
        echo "</table>";
