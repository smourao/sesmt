...
/**************************************************************************************************/
     echo "<td width=250 class='text roundborder' valign=top>";
                ...
                echo "<table width=100% border=0 cellspacing=3 cellpadding=2>";
                echo "<tr>";
				echo "<td class='text' align=center><input type='button' class='btn' name='btnAlt' value='Incluir' onclick=\"location.href='?dir=cad_col&p=a_reg&funcionario_id=$_GET[funcionario_id]&p=al_fer';\"  onmouseover=\"showtip('tipbox', '- Permite incluir/alterar as férias do colaborador da SESMT.');\" onmouseout=\"hidetip('tipbox');\"></td>";
				echo "</tr>";
				echo "</table>";
...
/**************************************************************************************************/
	...
	$list = @pg_fetch_all($result_func);
        ...
        for($i=0;$i<@pg_num_rows($result_func);$i++){
            ...
            echo "<td align=left class='text roundborder curhand' >".date("d/m/Y", strtotime($list[$i][inicio]))." à ".date("d/m/Y", strtotime($list[$i][termino]))."&nbsp;</td>";
            echo "<td align=center class='text roundborder '><a href='?dir=cad_col&remove={$list[$i]['id']}&p=in_fer&funcionario_id=".$_GET[funcionario_id]."' >Excluir</a></td>";
            echo "</tr>";
        }
        echo "</table>";
