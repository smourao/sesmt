...
if($_GET[sv] == 1){
	...
	$sql = "INSERT INTO gm_dt(cod_mensagem, enviar, data, hora, c_ativo, c_comercial, c_parceria, c_cortesia, c_contador, c_todos, dia, mes, ano) VALUES('$cod_mensagem', '$enviar', '$data', '$hora', '$c_ativo', '$c_comercial', '$c_parceria', '$c_cortesia', '$c_contador', '$todos', '$diadata', '$mesdata', '$anodata')";
	$query = pg_query($sql);
	//CADASTRAR REPETIÇÃO
	for($x=0;$x<count($meses);$x++){
		...
		if($dt[1] != $meses[$x]){
			$sql = "INSERT INTO gm_dt(cod_mensagem, enviar, data, hora, c_ativo, c_comercial, c_parceria, c_cortesia, c_contador, c_todos, dia, mes, ano) VALUES('$cod_mensagem', '$enviar', '$dat', '$hora', '$c_ativo', '$c_comercial', '$c_parceria', '$c_cortesia', '$c_contador', '$todos', '$diadata', '$meses[$x]', '$ano')";
			$query = pg_query($sql);
		}
	}
}
