...
/****************************************************************************************************************/
	...
	$cabecalho .= '<p><table width="100%"  border="0" style="border: 1px solid black;" cellspacing="0" bordercolor="#000000"><tr><td width=16% ><center><b>Medidas</b></center></td><td width=84%><center><b>('.str_pad($num_cod, 2, "0", STR_PAD_LEFT).') '.$material['nome'];
