<?PHP
if($_POST[mang] != ""){
	$query_incluir="INSERT into diametro_mangueira (diametro_mangueira, descricao) values ('$_POST[mang]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Diâmetro da Mangueira Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Diâmetro:</b></td>";
        echo "<td align=left width=200><input id='mang' type='text' name='mang' size=40></td>";
        echo "</tr>";
