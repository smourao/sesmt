<?PHP
if($_POST[contato] != ""){
	$query_incluir="INSERT into contato_com_agente (nome, descricao) values ('$_POST[contato]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Contato Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Contato:</b></td>";
        echo "<td align=left width=200><input id='contato' type='text' name='contato' size=40></td>";
        echo "</tr>";
