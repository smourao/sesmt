...
/******************** DADOS **********************/
if (!empty($cod_clinica) and !empty($mes1) and $mes!=12){
		$consulta = "SELECT r.*, c.*
					FROM repasse r, clinicas c  
					WHERE (r.confirma_data BETWEEN '".$ano."-".$mes1."-21' AND '".$ano."-".$mes2."-20') 
		...
		$consulta = "SELECT r.*, c.*
					FROM repasse r, clinicas c  
					WHERE (r.confirma_data BETWEEN '2012-12-21' AND '2013-01-20') 
					AND r.cod_clinica = $cod_clinica 
					AND c.cod_clinica = $cod_clinica
		...
		$consulta = "SELECT r.*, c.*
					FROM repasse r, clinicas c  
					WHERE (r.confirma_data BETWEEN '2013-12-21' AND '2014-01-20') 
					AND r.cod_clinica = $cod_clinica 
					AND c.cod_clinica = $cod_clinica
					ORDER BY r.confirma_data";
		...
		$consulta = "SELECT r.*, c.*
					FROM repasse r, clinicas c  
					WHERE (r.confirma_data BETWEEN '2015-12-21' AND '2016-01-20') 
					AND r.cod_clinica = $cod_clinica 
					AND c.cod_clinica = $cod_clinica
					ORDER BY r.confirma_data";
...
if($mes!=12){
	...
	$code .= "<tr><td><b>Bco: </b>001</td></tr>";
	$code .= "<tr><td><b>Agência: </b>0576-2</td></tr>";
	//$code .= "<tr><td><b>Operação: </b>001</td></tr>";
	$code .= "<tr><td><b>Conta Corrente: </b>54468-X</td></tr>";
	...
	$code .= "<tr><td><b>Data da emissao: </b>20/". $mes2 ."/".$ano."</td></tr>";
	$code .= "<tr><td><b>Periodo de cobrança: </b>21/". $mes1 ."/".$ano." a 20/". $mes2 ."/".$ano."</td></tr>";
	$code .= "<tr><td><b>Vencimento: </b>25/". $mes2 ."/".$ano."</td></tr>";
	$code .= "</table>";
	$code .= "</td></tr></table><p />";
	...
	$code .= "<tr><td><b>CNPJ: </b>".$buffer[0][cnpj_clinica]."</td></tr>";
	$code .= "<tr><td><b>Codigo do cliente: </b>".$buffer[0][cod_clinica]."</td></tr>";
	$code .= "<tr><td><b>Data da emissao: </b>20/01/2016</td></tr>";
	$code .= "<tr><td><b>Periodo de cobrança: </b>21/12/2015 a 20/01/2016</td></tr>";
