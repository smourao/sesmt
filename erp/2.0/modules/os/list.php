<?PHP
        ...
        for($x=0;$x<pg_num_rows($result);$x++){
            switch($status[$x][status]){
                case 0:
                    echo "<tr>";
                    echo "<td align=left class=fontebranca12 width=30%><b>O.S. Abertas:</b></td>";
                    echo "<td class=fontebranca12 align=left width=30%>{$status[$x][n]}</td>";
        			echo "<td align=left class=fontebranca12 width=30%><b>Legenda:</b></td>";
                    echo "</tr>";
                break;
                case 1:
                    echo "<tr>";
                    echo "<td align=left class=fontebranca12 width=30%><b>O.S. Finalizadas:</b></td>";
                    echo "<td class=fontebranca12 align=left width=30%>{$status[$x][n]}</td>";
					echo "<td align=left class=fontebranca12 width=30%><b>Nova Menssagem:</b></td>";
					echo "<td width=10%><img src='images/new.gif' border=0 width=21 height=12></td>";
                    echo "<td>";
                    echo "</tr>";
                break;
                case 2:
                    echo "<tr>";
                    echo "<td align=left class=fontebranca12 width=30%><b>O.S. em Execução:</b></td>";
                    echo "<td class=fontebranca12 align=left width=30%>{$status[$x][n]}</td>";
					echo "<td align=left class=fontebranca12 width=30%><b>Menssagem Lida:</b></td>";
					echo "<td width=10%><img src='images/nonew_readed.png' border=0 width=21 height=16></td>";
                    echo "<td>";
                    echo "</tr>";
                break;
                case 3:
                    echo "<tr>";
                    echo "<td align=left class=fontebranca12 width=30%><b>O.S. Canceladas:</b></td>";
                    echo "<td class=fontebranca12 align=left width=30%>{$status[$x][n]}</td>";
					echo "<td align=left class=fontebranca12 width=30%><b>Menssagem p/ setor:</b></td>";
					echo "<td width=10%><img src='images/nonew.gif' border=0 width=21 height=12></td>";
                    echo "<td>";
                    echo "</tr>";
                break;
                case 4:
                    echo "<tr>";
                    echo "<td align=left class=fontebranca12 width=30%><b>O.S. Excluídas:</b></td>";
                    echo "<td class=fontebranca12 align=left width=30%>{$status[$x][n]}</td>";
                    echo "<td>";
                    echo "</tr>";
                break;
                case 5:
                    echo "<tr>";
                    echo "<td align=left class=fontebranca12 width=30%><b>O.S. Pendentes:</b></td>";
                    echo "<td class=fontebranca12 align=left width=30%>{$status[$x][n]}</td>";
                    echo "<td>";
                    echo "</tr>";
                break;
        ...
        echo "<tr>";
        echo "<td align=left class=fontebranca12 width=195><b>Pesquisar:</b></td>";
        echo "<td align=left><input type=text value='{$_POST[search]}' name=search size=30> <input type=submit value='Pesquisar' class='btn'> </td>";
        echo "</tr>";
		echo "</table>";
        echo "</FORM>";
        echo "<br />";
        ...
        if($_POST){
            if($user_data[funcionario_id] != 18){
            ...
            if($user_data[cod_setor] && $user_data[funcionario_id] != 18 && $user_data[funcionario_id] != 33){
                if($user_data[funcionario_id] == 10 || $user_data[funcionario_id] == 4){ //10 = Luciana
