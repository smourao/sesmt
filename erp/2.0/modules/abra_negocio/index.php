     ...
     echo "<td width=250 class='text roundborder' valign=top>";
            //BUSCA DA LISTA DE ACESSO ABRA SEU NEGÓCIO
                ...
                echo "<form method=POST name='form1' action='?dir=abra_negocio&p=index'>";
					...
					echo "<input type='text' class='inputText' name='email' id='email' size=25></td>";
					echo "</tr>";
...
/**************************************************************************************************/
	...
	echo "<table width=100% border=0 align=center cellpadding=5 cellspacing=0>";
	  echo "<tr>";
		...
		echo "<td align=center class='text roundborder '><b><a href=\"javascript:location.href='index.php?dir=abra_negocio&p=index&order=acessos'\">Acesso</a></b></td>";
		echo "<td align=center class='text roundborder '><b><a href=\"javascript:location.href='index.php?dir=abra_negocio&p=index&order=data'\">Último Acesso</a></b></td>";
	  echo "</tr>";
	
	for($x=0;$x<pg_num_rows($res);$x++){
		echo "<tr>";
		echo "<td class='text roundborder ' align=center>".($x+1)."</td>";
		echo "<td class='text roundborder '><a href='index.php?dir=abra_negocio&p=access_log&user={$buffer[$x]['usuario']}'>{$buffer[$x]['usuario']}</a></td>";
