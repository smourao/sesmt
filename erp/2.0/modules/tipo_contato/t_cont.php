<?PHP
if($_POST[tipo] != ""){
	$query_incluir="INSERT into tipo_contato (nome, descricao) values ('$_POST[tipo]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Tipo de Contato Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Tipo Contato:</b></td>";
