<?PHP
if($_POST[risco] != ""){
	$query_incluir="INSERT into risco_cliente (nome, descricao) values ('$_POST[risco]', '$descricao')";
	
	if(pg_query($connect, $query_incluir)){
		showmessage('Risco Incluído com Sucesso!');
	}
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td height=50 align=left class='text' width=100><b>Característica do Risco</b></td>";
        echo "<td align=left width=200><input id='risco' type='text' name='risco' size=40></td>";
        echo "</tr>";
