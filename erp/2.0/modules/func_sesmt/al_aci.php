...
if($_POST && !empty($_GET[funcionario_id])){
	...
	$query_incluir = "INSERT INTO acid_trabalho
					 (funcionario_id, descricao)
					 VALUES 
					 ($funcionario_id, '$descricao')";
		
	pg_query($connect, $query_incluir);
	showmessage('Acidente do Trabalho do Colaborador Incluído com Sucesso!');
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<tr>";
		echo "<td align=left class='text' width=100><b>Descrição:</b></td>";
        echo "<td align=left width=220 ><textarea id=descricao type=text name=descricao cols=70 rows=2>&nbsp;</textarea></td>";
        echo "</tr>";
