...
/***************************************************************************************************/
$query_associada="SELECT * FROM associada where associada_id = $row[associada_id] ORDER BY nome";
...
/**************************************************************************************************/
     echo "<td width=250 class='text roundborder' valign=top>";
				...
				if(($_GET[funcionario_id] == 18) || ($_GET[funcionario_id] == 4)){
					
					echo "<td class='text' align=center><input type='button' class='btn' name='btnCont' value='Contra-Cheque' onclick=\"window.open('modules/func_sesmt/cont_cheque/?funcionario_id=$_GET[funcionario_id]', 'SESMT', 'height=1030, width=760, scrollbars = yes, status=yes, toolbar = yes, menubar=yes');\" onmouseover=\"showtip('tipbox', '- Permite visualizar o Doc. de abertura de conta do colaborador.');\" onmouseout=\"hidetip('tipbox');\"></td>";
				...
				echo "<td class='text' align=center><input type='button' class='btn' name='btnCont' value='Folha de Ponto' onclick=\"window.open('modules/func_sesmt/folhaponto/$_GET[funcionario_id]s.php', 'SESMT', 'height=1030, width=760, scrollbars = yes, status=yes, toolbar = yes, menubar=yes');\" onmouseover=\"showtip('tipbox', '- Permite visualizar a folha de ponto do colaborador.');\" onmouseout=\"hidetip('tipbox');\"></td>";
				
				
				echo "<td class='text' align=center><input type='button' class='btn' name='btnCont' value='Abertura Conta' onclick=\"window.open('modules/func_sesmt/ab_conta/?func_id=$_GET[funcionario_id]', 'SESMT', 'height=1030, width=760, scrollbars = yes, status=yes, toolbar = yes, menubar=yes');\" onmouseover=\"showtip('tipbox', '- Permite visualizar o Doc. de abertura de conta do colaborador.');\" onmouseout=\"hidetip('tipbox');\"></td>";
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td align=left class='text' width=220><input id='celular' type='text' name='celular' value='{$row[celular]}' size='18' maxlength='13' OnKeyPress=\"formatar(this, '##-##### ####');\"></td>";
        echo "</tr>";
