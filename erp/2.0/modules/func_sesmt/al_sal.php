...
if($_POST && !empty($_GET[funcionario_id])){
	...
	showmessage('Salário do Colaborador Alterado com Sucesso!');
}
...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<tr>";
        echo "<td align=center class='text roundborderselected'><b>Alterar Salário do Colaborador</b></td>";
        echo "</tr>";
        echo "</table><p>";
        ...
        echo "<td align=left width=220><input id='dt' type='text' name='dt' size='18' maxlength=10 onkeypress=\"formatar(this, '##/##/####');\" ></td>";
		echo "<td align=left class='text' width=100><b>Importância:</b></td>";
        echo "<td align=left width=220><input id='salario' type='text' name='salario' size='18' onkeypress=\"return FormataReais(this, '.', ',', event);\" ></td>";
        echo "</tr>";

        echo "<tr>";
		echo "<td align=left class='text' width=100><b>MDH:</b></td>";
        echo "<td align=left width=220><input id='mdh' type='text' name='mdh' size='18' ></td>";
        echo "</tr>";
