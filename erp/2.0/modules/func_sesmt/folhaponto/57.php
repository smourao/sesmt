...
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><strong>FUNÇÃO: </strong>Recepcionista </td>
  </tr>
  <tr>
    <td><strong>Nº REGISTRO: </strong>057 </td>
...
$pegarferiassql = "SELECT inicio, termino FROM ferias_sesmt WHERE funcionario_id = 57 ORDER BY id DESC";
