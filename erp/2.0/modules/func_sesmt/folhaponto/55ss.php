...
$nome = 'Peterson dos Santos Alves';
$lotacao = 'TI-SEG';
$carga_horaria = '40';
?>
...
<table width="97%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="28%" height="60"><img src="main-logo.png" width="264" height="60"></td>
    <td width="72%"><div align="left"><font size="2"><strong>
    EMPRESA: TI – Seg.Com Tecnologia da Informação Soluções em TI<br>
    CNPJ Nº: 11.356.967/0001-27 <br>
    ENDEREÇO: Rua George Bizet, 92 Sala 101</strong></font></div></td>
  </tr>
</table>
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><strong>SETOR:</strong> Informática</td>
    <td><strong>FUNÇÃO:</strong> Tec. Informática</td>
  </tr>
  <tr>
    <td><strong>Nº REGISTRO :</strong> 005</td>
    <td><strong>HORÁRIO:</strong> Seg. A Sexta Feira: 09hs ás 17hs</td>
  </tr>
  <tr>
    <td><strong>Horário Aos Sábados:</strong></td>
    <td><strong>Descanso Semanal:</strong></td>
  </tr>
</table>
...
$pegarferiassql = "SELECT inicio, termino FROM ferias_sesmt WHERE funcionario_id = 55 ORDER BY id DESC";
