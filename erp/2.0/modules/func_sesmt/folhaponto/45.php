...
$nome = 'Ana Carolina de Oliveira Alves';
$lotacao = 'SESMT';
$carga_horaria = '48';
?>
...
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><strong>SETOR: </strong>Recepção </td>
    <td><strong>FUNÇÃO: </strong>Assistente Administrativo </td>
  </tr>
  <tr>
    <td><strong>Nº REGISTRO: </strong>045 </td>
...
$pegarferiassql = "SELECT inicio, termino FROM ferias_sesmt WHERE funcionario_id = 45 ORDER BY id DESC";
