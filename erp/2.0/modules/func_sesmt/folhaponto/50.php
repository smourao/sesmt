...
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><strong>Nº REGISTRO :</strong> 001</td>
...
$pegarferiassql = "SELECT inicio, termino FROM ferias_sesmt WHERE funcionario_id = 50 ORDER BY id DESC";
