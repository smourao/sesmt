...
$nome = 'Marcia Regina Guimarães da Costa';
$lotacao = 'SESMT';
$carga_horaria = '48';
?>
...
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><strong>SETOR: </strong>Departamento Comercial </td>
    <td><strong>FUNÇÃO: </strong>Vendedor </td>
  </tr>
  <tr>
    <td><strong>Nº REGISTRO: </strong>056 </td>
...
$pegarferiassql = "SELECT inicio, termino FROM ferias_sesmt WHERE funcionario_id = 56 ORDER BY id DESC";
