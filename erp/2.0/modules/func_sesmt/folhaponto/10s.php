...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
        <td class='text' align=center>
          ...
          <a href="http://www.sesmt-rio.com/erp/2.0/modules/func_sesmt/folhaponto/10s.php?p=1"> <img src="main-logo.png" width="150" height="50"> </a>
          <a href="http://www.sesmt-rio.com/erp/2.0/modules/func_sesmt/folhaponto/10s.php?p=2"> <img src="sesmt-logo.png" width="200" height="50"> </a>
        </td>
        <td></td>
  </tr>
</table>
...
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><strong>SETOR: </strong>Departamento Médico </td>
    <td><strong>FUNÇÃO: </strong>Examinador </td>
  </tr>
  <tr>
    <td><strong>Nº REGISTRO: </strong>010 </td>
