...
$nome = 'Renata do Amaral Carvalho';
$lotacao = 'SESMT';
$carga_horaria = '48';
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
        <td class='text' align=center>
        	<b>Escolha um timbre!</b> <br>
        	<a href="http://www.sesmt-rio.com/erp/2.0/modules/func_sesmt/folhaponto/4s.php?p=1"> <img src="main-logo.png" width="150" height="50"> </a>
        	<a href="http://www.sesmt-rio.com/erp/2.0/modules/func_sesmt/folhaponto/4s.php?p=2"> <img src="sesmt-logo.png" width="200" height="50"> </a>
        </td>
        <td></td>
	</tr>
</table>
...
<table width="97%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <?php if($_GET['p'] == 1){ ?>
    <td width="32%" height="60"><img src="main-logo.png" width="450" height="90"></td>    
   <?php }else{ ?>
   <td width="32%" height="60"><img src="sesmt-logo.png" width="800" height="100"></td>    
   <?php } ?>
  </tr>
</table>
<table width="97%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><strong>SETOR: </strong>Administrativo </td>
    <td><strong>FUNÇÃO: </strong>Diretor Operacional </td>
  </tr>
  <tr>
    <td><strong>Nº REGISTRO: </strong>004 </td>
