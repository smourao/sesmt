...
/**************************************************************************************************/
    echo "<td class='text roundborder' valign=top>";
        ...
        echo "<td align=left width=220><input id='agencia1' type='text' name='agencia1' size='18' value='{$row_bus[agencia1]}' ></td>";
        echo "<td align=left class='text' width=100><b>Agência:</b></td>";
        echo "<td align=left class='text' width=220><input id='agencia2' type='text' name='agencia2' size='18' value='{$row_bus[agencia2]}' ></td>";
        echo "</tr>";

        echo "<tr>";
		echo "<td align=left class='text' width=100><b>Data da opção:</b></td>";
        echo "<td align=left width=220><input id='dtop' type='text' name='dtop' size='18' maxlength=10 value='".date("d/m/Y", strtotime($row_bus[data_opcao]))."'  onkeypress=\"formatar(this, '##/##/####');\" ></td>";
        echo "<td align=left class='text' width=100><b>Nº inscrição:</b></td>";
        echo "<td align=left class='text' width=220><input id='inscricao' type='text' name='inscricao' size='18' value='{$row_bus[inscricao]}' ></td>";
        echo "</tr>";
        ...
        echo "<td align=left width=220><input id='contrato' type='text' name='contrato' size='18' value='".str_pad($row_bus[contrato], 4,"0",STR_PAD_LEFT)."' ></td>";
        echo "<td align=left class='text' width=100><b>Reg. Folha:</b></td>";
        echo "<td align=left class='text' width=220><input id='folha' type='text' name='folha' size='18' value='".str_pad($row_bus[folha], 3,"0",STR_PAD_LEFT)."' ></td>";
        echo "</tr>";
        ...
        echo "<td align=left class='text' width=220><input id='dt' type='text' name='dt' size='18' maxlength=10 value='".date("d/m/Y", strtotime($row_bus[dt_admissao]))."'  onkeypress=\"formatar(this, '##/##/####');\" ></td>";
        echo "</tr>";

        echo "<tr>";
		echo "<td align=left class='text' width=100><b>Salário:</b></td>";
        echo "<td align=left width=220><input id='salario' type='text' name='salario' size='18' onkeypress=\"return FormataReais(this, '.', ',', event);\" value=".$row_alt[salario]." ></td>";
        echo "<td align=left class='text' width=100><b>Forma de pagamento:</b></td>";
        echo "<td align=left width=200><input id='pagamento' type='text' name='pagamento' size='18' value='{$row_bus[pagamento]}' ></td>";
        echo "</tr>";
        ...
        echo "<td align=left class='text' width=220><input id='hora3' type='text' name='hora3' size='5' maxlength='4' OnKeyPress=\"formatar(this, '#:##');\" value='{$row_bus[hora3]}'  onblur=\"calcula_horas();\" >horas</td>";
        echo "</tr>";

        echo "<tr>";
		echo "<td align=left class='text' width=100><b>Horas semanais:</b></td>";
        echo "<td align=left width=220><input id='hora4' type='text' name='hora4' size='5' value='{$row_bus[hora4]}' ></td>";
