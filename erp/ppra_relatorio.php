	...
	<div id="div_position" style="position:relative;left:-40px;"><img src="../img/uno_top.jpg" width="154" height="219"></div>
		...
		<td align="center"><p><h1><b>Programa<p>e<p>Prevenção<p>de<p>Riscos<p>Ambientais</b></h1><p><p>
			...
			<td align="left"><font class="fontepreta12">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NR 9 - MTE</b></font>
				<div id="grfg"></div><div id="div_position"><img src="../img/carimbo_assin.PNG" width="180" height="110"></div>
			</td>
			</tr>
			</table>
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<tr>
		<td align="center"><font size="4">Programa de Prevenção de Riscos Ambientais <?php if($row[data_criacao]){
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<tr>
			...
			<td class="tabela"><?php echo $row[numero_funcionarios]; ?></td>
		</tr>
		<tr>
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="699" height="<?php echo $hei; ?>" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			...
			<tr>
				...
				<td align="center" valign="top" class="fontepreta10">ControleRígido de Produtividade</td>
			...
			<tr>
				...
				<td align="center" valign="top" class="fontepreta10">&nbsp;</td>
				<td align="center" valign="top" class="fontepreta10">&nbsp;</td>
				<td align="center" valign="top" class="fontepreta10">Monotonia e Repetividade</td>
			...
			<tr>
				...
				<td align="center" valign="top" class="fontepreta10">Outras Situaçõesde Risco que Poderão Contribuir para a Ocorrência de Acidentes</td>
			</tr>
		</table>	
		<div id="grfg"></div><div id="div_position"><img src="../img/carimbo_assin.PNG" width="180" height="110"></div>
		<tr>
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<tr>
		<td>
		<table align="left" width="349" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td align="left" class="fontepreta12"><b>Local:</b> <?php echo $row_ativ[$x][nome_setor]; ?></td>
			</tr>
		</table>
		</td>
		<td>
		<table align="right" width="349" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td align="left" class="fontepreta12"><b>Atividade:</b> <?php echo $row_ativ[$x][desc_setor]; ?></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		<td align="left" valign="top" class="fontepreta12"><b>CARACTERÍSTICAS:</b><br>
		<table align="left" width="349" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td align="left" class="fontepreta12"><b>Edificação:</b> <?php echo $row_ativ[$x][descricao]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Piso:</b> <?php echo $row_ativ[$x][descricao_piso]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Parede:</b> <?php echo $row_ativ[$x][decicao_parede]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Cobertura:</b> <?php echo $row_ativ[$x][decicao_cobertura]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Luz Natural:</b> <?php echo $row_ativ[$x][descricao_luz_nat]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Luz Artificial:</b> <?php echo $row_ativ[$x][decricao_luz_art]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Vento Natural:</b> <?php echo $row_ativ[$x][decricao_vent_nat]; ?></td>
			</tr>
			<tr>
				<td align="left" class="fontepreta12"><b>Vento Artificial:</b> <?php echo $row_ativ[$x][decricao_vent_art]; ?></td>
			</tr>
		</table>
		</td>
		<td align="right" valign="top" class="fontepreta12"><b>IDENTIFICAÇÃO QUALITATIVA DE AGENTE NOCIVO:</b><br>
<?php
...
$ambiente = "select s.*, sa.descricao
from sugestao s, setor_ambiental sa 
where s.med_prev = sa.id
and s.cod_cliente = $cliente
AND s.cod_setor = {$row_ativ[$x]['cod_setor']}
and s.plano_acao = 1
AND EXTRACT(year FROM data) = {$ano}";
...
?>
	<table align="center" width="699" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
		<tr>
			...
			<tr>
				<td align="justify" class="fontepreta10">No Homem: Proteção Individual<br>
				<?php 
			...
			<tr>
				<td align="left" class="fontepreta10"><b>No Ambiente: Proteção Coletiva</b><br><?php echo $row_ativ[$x][epc_existente]; ?></td>
			</tr>
			</table>
			</td>
		</tr>
...
?>
	<table align="center" width="699" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
		<tr>
			...
			<table align="left" width="698" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td align="justify" class="fontepreta10"><b>No Homem: Proteção Individual</b><br>
				<?php 
				while($row_epi = pg_fetch_array($result_epi)){
					echo $row_epi[descricao]."; ";
				}
			...
			<tr>
				<td align="left" class="fontepreta10"><b>No Ambiente: Proteção Coletiva</b><br><?php echo $row_ativ[$x][epc_sugerido]; ?></td>
			</tr>
			</table>
			</td>
		</tr>
...
$sql_dados = "select t.nome, ca.nome as nome1
			 ...
			 where r.cod_cliente = c.cod_cliente
					...
					AND EXTRACT(year FROM c.data_criacao) = EXTRACT(year FROM r.data)
...
for($k=0;$k<pg_num_rows($res_info);$k++){
	$sql = "SELECT diagnostico FROM risco_setor WHERE cod_agente_risco = {$row_info[$k][cod_agente_risco]} AND EXTRACT(year FROM data) = {$ano}";
	$r = pg_query($sql);
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="550" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				...
				<table align="center" width="550" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
					<tr>
						<td align="center">
						<table align="center" width="135" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							<tr>
						...
						<td align="center">
						<table align="center" width="135" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
							<tr>
								<td align="center" class="fontepreta12"><?php echo $row_fase[$w][nome]; ?></td>
							</tr>
							<tr>
								<td align="center" class="fontepreta12">Ruídos</td>
							</tr>
							<tr>
								<td align="center" class="fontepreta12"><?php echo $row_fase[$w][data_avaliacao]; ?></td>
							</tr>
							<tr>
								<td align="center" class="fontepreta12"><?php echo $row_fase[$w][hora_avaliacao]; ?></td>
							</tr>
						</table>
						</td>
						<td align="center">
						...
						<table align="center" width="135" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
							<tr>
								...
								$qtd = "SELECT f.* FROM funcionarios f
										WHERE (f.setor_adicional LIKE '%{$row_ativ[$x]['cod_setor']}%')
							...
							<tr>
								<td align="center" class="fontepreta12"><?php echo $row_fase[$w][nome_aparelho]; ?></td>
							</tr>
							<tr>
								<td align="center" class="fontepreta12"><?php echo $row_fase[$w][ruido_fundo_setor]; ?></td>
							</tr>
							<tr>
								<td align="center" class="fontepreta12"><?php echo $row_fase[$w][ruido_operacao_setor]; ?></td>
							</tr>
						</table>
						</td>
					</tr>
		...
		<table align="center" width="699" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			...
			<tr>
				...
				$func = "SELECT f.* FROM funcionarios f, cliente_setor cs
						WHERE cs.cod_cliente = f.cod_cliente
						AND (cs.cod_setor = f.cod_setor OR f.setor_adicional LIKE '%{$row_ativ[$x]['cod_setor']}%')
						AND cs.cod_cliente = $cliente
						AND	cs.cod_setor = {$row_ativ[$x]['cod_setor']}";
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="699" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td width="97" align="center" class="fontepreta12bold">Setor</td>
				<td width="217" align="center" class="fontepreta12bold">Fonte de Iluminação</td>
				<td width="75" align="center" class="fontepreta12bold">Data Avaliação</td>
				<td width="65" align="center" class="fontepreta12bold">Tempo Exp./dia</td>
				<td width="75" align="center" class="fontepreta12bold">Avaliação Pontual</td>
				<td width="70" align="center" class="fontepreta12bold">VR* por Atividade</td>
				<td width="100" align="center" class="fontepreta12bold">Quadro da Priorização</td>
			</tr>
			<?php 
			$i = $y*5;
			for($x=$i;$x<$i+5;$x++){ 
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<b>ESTABELECIMENTO DE PRIORIDADES E METAS DE AVALIAÇÃO E CONTROLE</b><p align="left">
		<b>Categoria de Riscos:</b><br>
		<table align="center" width="699" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<b>Avaliação de Riscos do PPRA</b><br>
		<b>VALORAÇÃO DE PRIORIDADES</b><p align="left">
		<b>Tabela 1 - Graduação Qualitativa de Exposição</b><p>
...
<?php
for ($p=0;$p<ceil(count($contem)/4);$p++) { ?>
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	<tr>
		<td class="tabela" valign="top">
			<?php 
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="699" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td width="78" align="center" class="fontepreta12">Setor&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="78" align="center" class="fontepreta12">Agente</td>
				<td width="78" align="center" class="fontepreta12">Nível&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="90" align="center" class="fontepreta12">Grau de Itensidade e efeitos</td>
				<td width="90" align="center" class="fontepreta12">Danos à Saúde</td>
				<td width="78" align="center" class="fontepreta12">Escala de Ação</td>
				<td width="205" align="center" class="fontepreta12">Ações Necessárias</td>
			</tr>
			<tr>
...
$curso = "select s.*, fc.descricao, st.nome_setor
...
$result_extintor = pg_query($connect, $extintor) or die
	("erro na query:$extintor==>".pg_last_error($connect));
      ...
      for($i=0;$i<pg_num_rows($result_extintor);$i++){
            ...
            echo "<tr>";
			echo "	<td align=left class=fontepreta10>Instalar Extintor Tipo {$extintor_list[$i][tipo_extintor]}</td>";
			echo "	<td align=center class=fontepreta12>";
			echo "		<table align=center width=262 border=1 cellpadding=0 cellspacing=0 bordercolor=#000000>";
			echo "			<tr>";
...
$placas = "select pp.descricao, pp.cod_cliente, pp.cod_setor
	  ...
	  AND pp.cod_cliente = $cliente
	  AND pp.cod_setor = {$row_ativ[$a]['cod_setor']}
	  AND EXTRACT(year FROM pp.data) = EXTRACT(year FROM c.data_criacao)
	  AND EXTRACT(year FROM c.data_criacao) = {$ano}";
...
from cliente_setor
where cod_cliente = $cliente
AND cod_setor = {$row_ativ[0]['cod_setor']}
AND EXTRACT(year FROM data_criacao) = {$ano}";
...
echo "<tr>";
	for($y=1;$y<=12;$y++){
	   if(in_array($mesa1, $datas)){
		  echo "<td width=20 align=center bgcolor=black class=fontepreta12>&nbsp;</td>";
	   }else{
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<b>MODELO DE FICHA DE INSPEÇÃO DE EXTINTOR</b><p>
		<table align="center" width="600" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
			...
			<tr>
				...
				<td rowspan="15" align="left" class="fontepreta12"><br>1. Substituição de gatilho<p>2. Substituição de difisor<p>3. Mangote<p>4. Válvula de segurança<p>5. Válvula completa<p>6. Válvula cilindro adicional<p>7. Pintura<p>8. Manômetro<p>9. Teste hidrostático<p>10. Recarregado<p>11. Usado em incêndio<p>12. Usado em instrução<p>13. Diversos</td>
			</tr>
			<tr>
				<td colspan="2">
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<b>ANEXO 3 - FICHA DE RECEBIMENTO DE MATERIAL</b><br>
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<b>ANEXO 4 – FICHA DE INSPEÇÃO DE ACIDENTE</b>
		<table align="center" width="600" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="600" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td align="left"><img src="../img/ass_pedro3.png" width="486" height="157" border="0"></td>
			</tr>
		</table>
		<tr>
			<td class="tabela" valign="bottom">
