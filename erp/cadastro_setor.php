...
if($valor=="gravar"){
	...
	$query_insert="insert into setor_cliente (setor, cod_setor, cliente_id, filial_id) values('$nome_setor', '$cod_setor', $cod_cliente, $filial_id)";
	$result_insert=pg_query($query_insert)or die("erro ao inserir dados $query_insert".pg_last_error($connect));
	
	$query_cliente_cod="select cliente_id from setor_cliente where setor='$nome_setor' and cod_setor='$cod_setor' and cliente_id=$cod_cliente and filial_id=$filial_id";
...
<title>Sistema SESMT - Cadastro de Setor</title>
