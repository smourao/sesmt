...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		...
		<td class="fontepreta12" align="left"><input type="text" name="razao_social_cliente" id="razao_social_cliente" size="90" value="<?php echo $row[razao_social_cliente]; ?>" ></td>		
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	<tr>
		<td width="70%" align="left" class="fontepreta12 style2">End. &nbsp;<input type="text" name="endereco_cliente" id="endereco_cliente" size="60" value="<?php echo $row[endereco_cliente] ?>"  /></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		<td class="fontepreta12" align="left"><input type="text" name="cnpj_cliente" id="cnpj_cliente" size="20" value="<?php echo $row[cnpj_cliente] ?>" maxlength="18" OnKeyPress="formatar(this, '##.###.###/####-##');"  /></td>
		...
		<td class="fontepreta12" align="left"><input type="text" name="tipo_exame" id="tipo_exame" size="21" value="<?php echo $row[tipo_exame] ?>" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
