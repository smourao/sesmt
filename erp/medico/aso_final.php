...
$funcionario = ucwords(strtolower($funcionario));
...
<br />
	<tr>
		...
		encontra-se <strong><?php echo $row_func[aso_resultado] ?></strong> mediante ter sido <?php if($row_func[aso_resultado] == 'INAPTO' || $row_func[aso_resultado] == 'Inapto'){ echo 'reprovado'; }else{ echo 'aprovado'; } ?> nos
...
<p>
	<tr>
		...
		<td width="35%" align="right"><img src="../img/logo_novo_sesmt2.png" width="240" height="180" /></td>
	</tr>
</table>
<?PHP
}else{
