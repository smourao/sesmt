...
if($vaiqvai > 0){	
	...
	$query_func = "INSERT INTO ASO_AVULSO 
							...
							grau_risco, tipo_exame, nome_func, num_ctps_func, rg, serie_ctps_func, cbo, nome_funcao,
						...
						VALUES
							($cod_aso, '$razao_social_cliente', '$endereco_cliente', '$cep_cliente', '$cnpj_cliente', '$cnae',
							'$grau_risco', '$tipo_exame', '$nome_func', '$num_ctps_func', '$rg', '$serie_ctps_func', '$cbo',
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		<td class="fontepreta12" align="left"><input type="text" name="nome_func" size="80" value="<?php echo $row[nome_func] ?>" required="required"></td>
        <td class="fontepreta12" align="left"><input type="text" name="rg" size="20" value="<?php echo $row[rg] ?>"></td>
	</tr>
</table></div>
<div align="center">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
...
<br />
	<tr>
		...
		?> mediante ter sido <?php if($row[resultado] == 'INAPTO' || $row[resultado] == 'Inapto'){ echo 'reprovado'; }else{ echo 'aprovado'; } ?> nos
