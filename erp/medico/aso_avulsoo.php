...
if($vaiqvai > 0){	
	...
	$nodoblesql = "SELECT * FROM aso_avulso WHERE razao_social_cliente = '$razao_social_cliente' AND nome_func = '$nome_func' AND tipo_exame = '$tipo_exame' AND nome_funcao = '$nome_funcao' AND cod_tipo_risco = '$texto' AND cod_agente_risco = '$texto_especif' AND cod_exame = '$texto_exa' AND data = '$data' ";
