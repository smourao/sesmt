...
if($vaiqvai > 0){	
	...
	$razao_social_cliente = ucwords(strtolower($razao_social_cliente));
	$endereco_cliente = ucwords(strtolower($endereco_cliente));
	...
	$receita1sql = "INSERT INTO financeiro_info (id, titulo, valor_total, n_parcelas, forma_pagamento, status, data, dia, mes ,ano, data_lancamento, data_entrada_saida, tipo_lancamento, historico, funcionario_id, pc) VALUES ($cod_fatura, '$razao_social_cliente', $preco_aso, 1, 'Dinheiro', 0, '$datafatura', '$dia', '$mes', '$ano', '$datafatura', '$datafatura', 24, '$descricao_aso', 0, 0)";
	
	$receita1query = pg_query($receita1sql);
	
	//Inserindo na Tabela financeiro_fatura
	
	$receita2sql = "INSERT INTO financeiro_fatura (id, cod_fatura, titulo, valor, parcela_atual, vencimento, status, pago, data_lancamento, numero_doc, numero_cheque) VALUES ($cod_fatura2, $cod_fatura, '$razao_social_cliente', $preco_aso2, 1, '$datafatura', 0, 1, '$datafatura', '', '')";
	...
	$relatoriosql = "INSERT INTO financeiro_relatorio (id, cod_fatura, titulo, valor, status, pago, historico, data_lancamento, semana, ano) VALUES ($cod_relatorio, $cod_fatura, '$razao_social_cliente', $preco_aso, 0, 1, '$descricao_aso', '$datafatura', $semana, $anointeiro)";
...
<!DOCTYPE HTML PUBLIC -//W3C//DTD HTML 4.0 Transitional//EN>
		...
		$msgg .= "Endereço: ".$endereco_cliente."<br>";
...
<script type='text/javascript' src='cnpj_avulso.js'></script>
...
<font face="Verdana, Arial, Helvetica, sans-serif">Médico Coordenador do PCMSO:<br />
		  Maria de Lourdes Fernandes Magalhães<br />
	      CREMERJ 52.33.471-0 Reg. MTE 13.320 </font></p>
<?PHP
}else{
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		<td class="fontepreta12" align="left"><input type="text" name="codaso" size="5" value="<?php if(empty($cod_aso)){coloca_zeros($row_max[cod_aso]);} else {echo coloca_zeros($cod_aso);}?>" readonly="true" required="required"></td>
		<td class="fontepreta12" align="left"><input type="text" name="razao_social_cliente" id="razao_social_cliente" size="90" value="<?php echo $row[razao_social_cliente]; ?>" required="required"></td>		
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	<tr>
		<td width="70%" align="left" class="fontepreta12 style2">End. &nbsp;<input type="text" name="endereco_cliente" id="endereco_cliente" size="60" value="<?php echo $row[endereco_cliente] ?>" required="required"></td>
		<td width="30%" align="left" class="fontepreta12 style2">CEP &nbsp;<input type="text" name="cep_cliente" id="cep_cliente" size="15" value="<?php echo $row[cep_cliente] ?>"  /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		<td class="fontepreta12" align="left"><input type="text" name="cnpj_cliente" id="cnpj_cliente" size="20" value="<?php echo $row[cnpj_cliente] ?>" maxlength="18" OnKeyPress="formatar(this, '##.###.###/####-##');" required="required"></td>
		<td class="fontepreta12" align="left"><input type="text" name="cnae" id="cnae" size="10" value="<?php echo $row[cnae] ?>"  /></td>
		<td class="fontepreta12" align="left"><input type="text" name="grau_risco" id="grau_risco" size="5" value="<?php echo $row[grau_risco] ?>" /></td>
		<td class="fontepreta12" align="left"><input type="text" name="tipo_exame" id="tipo_exame" size="21" value="<?php echo $row[tipo_exame] ?>" required="required"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		<td class="fontepreta12" align="left"><input type="text" name="nome_func" size="100" value="<?php echo $row[nome_func] ?>" required="required"></td>
	</tr>
</table></div>
<div align="center">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
<br />
	<tr>
		...
		<td width="65%" align="left" class="fontepreta12 style2">Função &nbsp;<input type="text" name="nome_funcao" size="50" value="<?php echo $row[nome_funcao] ?>" required="required"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		...
		<!--<th class="fontepreta12 style2" width="380">Assinatura do Examinador<br>Maria de Lourdes F. Magalhães<br>CREMERJ 52.33.471-0<br>Reg. MTE 13.320</th>-->
	</tr>
</table></div>
<div align="center">
<?PHP if(!$_GET['sem*timbre']){?>
...
echo '<br /><br /><br /><br /><br /><br /><br /><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	<tr>
		<td width="65%" align="center" class="fontepreta12 style2">
		  ...
		  Nextel: (55 - *21) 97003-1385 &nbsp;&nbsp;ID:55*23*31641
		  <br />
