...
if($vaiqvai > 0){	
	...
	$datafatura = $novadata->format('Y-d-m');
	...
	$receita1sql = "INSERT INTO financeiro_info (titulo, valor_total, n_parcelas, forma_pagamento, status, data, dia, mes ,ano, data_lancamento, data_entrada_saida, tipo_lancamento, historico, funcionario_id, pc) VALUES ('$razao_social_cliente', 35.00, 1, 'Dinheiro', 0, '$data', '$dia', '$mes', '$ano', '$data', '$data', 24, 'Pagamento aso avulso', 0, 0)";
	...
	$receita2sql = "INSERT INTO financeiro_fatura (cod_fatura, titulo, valor, parcela_atual, vencimento, status, pago, data_lancamento, numero_doc, numero_cheque) VALUES ($cod_fatura, '$razao_social_cliente', 35, 1, '$data', 0, 1, '$data', '', '')";
