...
<table width="90%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		...
		<td class="fontepreta12" align="left"><select name="aso_resultado" id="aso_resultado" onchange="apto(this.value);">
                ...
                <option value="Apto para trabalhar em altura e espaço confinado" <?php if($buffer[aso_resultado]=="Apto para trabalhar em altura e espaço confinado"){echo "selected";} ?>>Apto para trabalhar em altura e espaço confinado</option>
				</select>
		</td>
	</tr>
</table></div><br />
