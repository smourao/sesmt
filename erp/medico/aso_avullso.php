...
if($vaiqvai > 0){	
	...
	$receita2sql = "INSERT INTO financeiro_fatura (cod_fatura, titulo, valor, parcela_atual, vencimento, status, pago, data_lancamento, numero_doc, numero_cheque) VALUES ($cod_fatura, '$razao_social_cliente', 35, 1, '$datafatura', 0, 1, '$datafatura', '', '')";
