...
if (!empty($funcionario) and !empty($aso)){
		$query_func = "SELECT f.cod_func, f.nome_func, f.num_ctps_func, f.serie_ctps_func, f.cbo, f.dinamica_funcao -- funcionário
						   , a.cod_aso, a.tipo_exame, a.aso_resultado -- aso 
...
<tr>
<td>
<table border="0" width="760" height="900" align="center" cellpadding="0" cellspacing="0">
<tr>
<td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	<tr>
		<td width="70%" align="left" class="fontepreta12 style2">End. &nbsp;<input type="text" name="endereco" size="60" value="<?php echo $row_func[endereco] ?>" readonly="true" /></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	<tr>
		<td width="100%" align="left" class="fontepreta12 style2">Atividade Laborativa&nbsp;<input type="text" name="ativ_laborativa" size="95" value="Pintam estrutura de ferro utilizando jato de tinta<?php //echo $row_func[dinamica_funcao] ?>" readonly="true" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	...
	<tr>
		...
		if( !empty($funcionario) and !empty($aso) ){
			$query_exame="SELECT e.cod_exame, e.especialidade
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
	<br /><br />
	<tr>
		<th width="50%">_________________________________</th>
		<th width="50%">_________________________________</th>
	</tr>
	<tr>
