   ...
   // echo "<td align=center><b><font size=1>Valor</font></b></td>";
    echo "</tr>";
        for($x=0;$x<pg_num_rows($result);$x++){
            echo "<tr>";
               echo "<td align=center style=\"cursor:pointer;\" onclick=\"window.opener.location.replace('cadastro_cliente.php?cliente_id={$buffer[$x]['cliente_id']}&filial_id={$buffer[$x]['filial_id']}');\"><font size=1>Selecionar</font></td>";
