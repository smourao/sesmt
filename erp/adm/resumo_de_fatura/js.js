...
if (chave == ''){
overlib('Por favor, antes de clicar no botão <b>ok</b> digite a <b>palavra chave</b> para busca com no mínimo 3 caracteres!');
}
}
...
prompt('Informe seu email de cadastro')
}



  function verificar(obj, nomecampo){
