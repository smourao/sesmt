...
$query="select * from placa_sinalizacao";
/*
switch($grupo){
...
<title>Lista de Placas de Sinaliza&ccedil;&atilde;o</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "placa_sinalizacao_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "placa_sinalizacao_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Caracter&iacute;stica Id </div></td>
    <td width="160" class="linhatopodir"><div align="center" class="fontebranca12">Placa Sinaliza&ccedil;&atilde;o  </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10">&nbsp;<?=$row[placa_sinalizacao_id]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10">&nbsp;<?=$row[placa_sinalizacao]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10">&nbsp;<?=$row[descricao]?></div></td>
    <td class="linhatopodir"><div align="center"><input name="id[]" type="checkbox" id="id[]" value="<?=$row[placa_sinalizacao_id]?>"></div></td>
  </tr>
  <?php
  }
  ?>
