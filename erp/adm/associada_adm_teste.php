...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "associada_excluir_teste.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "associada_incluir_teste.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<br>
<form action="associada_adm_teste.php" method="post" name="riscos" id="riscos">
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="121" class="linhatopodiresq"><div align="center" class="fontebranca12">Associada Id </div></td>
    <td width="201" class="linhatopodir"><div align="center" class="fontebranca12">Nome</div></td>
    <td width="147" class="linhatopodir"><div align="center" class="fontebranca12">Telefone</div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[cod_unidade]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[nome_unidade]?>
    </div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[tel_unidade]?>
    </div></td>
    <td class="linhatopodir"><input name="cod_unidade[]" type="checkbox" id="cod_unidade[]" value="<?=$row[cod_unidade]?>"></td>
  </tr>
  <?php
  }
  ?>
