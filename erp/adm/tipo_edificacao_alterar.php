...
echo"<script>
alert('Edificação Alterada com Sucesso!');
...
<title>Alterar Edificação</title><body bgcolor="#006633">
<form action="tipo_edificacao_alterar.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">Tipo de Edificação</font></div></td>
    </tr>
	<tr>
	...
	<tr>
		<td class="fontebranca12">Tipo Edificação</td>
