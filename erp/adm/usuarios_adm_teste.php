...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "usuarios_excluir_teste.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "usuarios_incluir_teste.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[nome_usuario]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[login]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[cod_grupo]?></div></td>
    <td class="linhatopodir"><input name="nome_usuario[]" type="checkbox" id="nome_usuario[]" value="<?=$row[nome_usuario]?>"></td>
  </tr>
  <?php
  }
  ?>
