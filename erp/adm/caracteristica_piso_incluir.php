...
ob_start();
if($tipo!=""){
$query_incluir="INSERT into caracteristica_piso (caracteristica_piso, descricao) values ('$tipo', '$descricao')";
pg_query($query_incluir) or die ("Erro na query:$query_incluir".pg_last_error($connect));

echo"<script>alert('Característica do Piso Incluído com Sucesso!');</script>";
...
<title>Cadastro de Caracteristicas do Piso</title><body bgcolor="#006633">
<form name="form1" method="post" action="caracteristica_piso_incluir.php">
	...
	<tr>
      <td colspan="4" class="fontebranca12"><table width="499" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<td class="fontebranca12"><input name="btn_voltar" type="submit" id="btn_voltar" onClick="MM_goToURL('parent','caracteristica_piso_adm.php'); return document.MM_returnValue" &nbsp;&nbsp; value="&lt;&lt; Voltar"></td>
          </tr>
		  </table></td></tr>
      </table></td>
    </tr>
