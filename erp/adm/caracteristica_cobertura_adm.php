...
$query="select * from cobertura order by cod_cobertura";
...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "caracteristica_cobertura_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "caracteristica_cobertura_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'A') {
	     document.forms[0].action = "caracteristica_cobertura_alterar.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="152" class="linhatopodir"><div align="center" class="fontebranca12">Tipo de Cobertura </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[cod_cobertura]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[nome_cobertura]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[decicao_cobertura]?></div></td>
    <td class="linhatopodir" align="center"><input name="cod_cobertura[]" type="checkbox" id="cod_cobertura[]" value="<?=$row[cod_cobertura]?>"></td>
  </tr>
  <?php
  }
  ?>
