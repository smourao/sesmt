...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "cargo_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "cargo_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="70" class="linhatopodiresq"><div align="center" class="fontebranca12">Cargo Id </div></td>
    <td width="191" class="linhatopodir"><div align="center" class="fontebranca12">Nome</div></td>
    <td width="208" class="linhatopodir"><div align="center" class="fontebranca12">Descri&ccedil;&atilde;o</div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[cargo_id]?></div></td>
    ...
    <td class="linhatopodir"><div align="center"><input name="cargo_id[]" type="checkbox" id="cargo_id[]" value="<?=$row[cargo_id]?>"></div></td>
  </tr>
  <?php
  }
  ?>
