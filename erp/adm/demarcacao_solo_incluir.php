...
ob_start();
if($tipo!=""){
$query_incluir="INSERT into demarcacao_solo (demarcacao_solo, descricao) values ('$tipo', '$descricao')";
pg_query($query_incluir) or die ("Erro na query:$query_incluir".pg_last_error($connect));

echo"<script>alert('Demarcacao do Solo Incluída com Sucesso!');</script>";
...
<title>Cadastro de Demarca&ccedil;&atilde;o de Solo</title><body bgcolor="#006633">
<form action="demarcacao_solo_incluir.php" method="post" name="demarcacao_solo" id="demarcacao_solo">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
      <td colspan="4" class="fontebranca12"><table width="499" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="157" class="fontebranca12">Demarca&ccedil;&atilde;o do Solo </td>
