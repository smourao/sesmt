...
$query="select * from tipo_edificacao order by tipo_edificacao_id";
$result=pg_query($query) or die("Erro na query: $query".pg_last_error($connect));
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Lista de Tipo de Edifica&ccedil;&atilde;o</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "tipo_edificacao_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "tipo_edificacao_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'A') {
	     document.forms[0].action = "tipo_edificacao_alterar.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">Tipo Edificação </font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="131" class="linhatopodir"><div align="center" class="fontebranca12">Tipo Edificação </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[tipo_edificacao_id]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[tipo_edificacao]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[descricao]?></div></td>
    <td class="linhatopodir" align="center"><input name="tipo_edificacao_id[]" type="checkbox" id="tipo_edificacao_id[]" value="<?=$row[tipo_edificacao_id]?>"></td>
  </tr>
  <?php
  }
  ?>
