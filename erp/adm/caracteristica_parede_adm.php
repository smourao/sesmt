...
$query="select * from parede order by cod_parede";
$result=pg_query($query) or die("Erro na query: $query".pg_last_error($connect));
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Lista de Caracteristicas da Parede</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "caracteristica_parede_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "caracteristica_parede_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'A') {
	     document.forms[0].action = "caracteristica_parede_alterar.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="152" class="linhatopodir"><div align="center" class="fontebranca12">Característica da Parede </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[cod_parede]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[nome_parede]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[decicao_parede]?></div></td>
    <td class="linhatopodir" align="center"><input name="cod_parede[]" type="checkbox" id="cod_parede[]" value="<?=$row[cod_parede]?>"></td>
  </tr>
  <?php
  }
  ?>
