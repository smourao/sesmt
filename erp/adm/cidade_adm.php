...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "cidade_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "cidade_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">Cidade e DDD </font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Estado </div></td>
    <td width="131" class="linhatopodir"><div align="center" class="fontebranca12">Cidade</div></td>
    <td width="147" class="linhatopodir"><div align="center" class="fontebranca12">C&oacute;d. DDD</div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[uf]?></div></td>
    ...
    <td class="linhatopodir"><input name="cidade_id[]" type="checkbox" id="cidade_id[]" value="<?=$row[cidade_id]?>"></td>
  </tr>
  <?php
  }
  ?>
