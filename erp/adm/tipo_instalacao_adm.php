...
$query="select * from tipo_instalacao";
/*
switch($grupo){
...
<title>Lista de Tipo de Instala&ccedil;&atilde;o</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "tipo_instalacao_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "tipo_instalacao_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="160" class="linhatopodir"><div align="center" class="fontebranca12">Tipo de Instala&ccedil;&atilde;o </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[tipo_instalacao_id]?></div></td>
    ...
    <td class="linhatopodir"><input name="id[]" type="checkbox" id="id[]" value="<?=$row[tipo_instalacao_id]?>"></td>
  </tr>
  <?php
  }
  ?>
