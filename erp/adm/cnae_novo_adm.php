...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "cnae_novo_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "cnae_novo_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  	  if(opcao == 'A') {
	     document.forms[0].action = "cnae_novo_alterar.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="6" class="fontebranca12"><div align="center" class="fontebranca22bold">Painel de Controle do Sistema </div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div></td>
  </tr>
  <tr>
    <td colspan="6" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">CNAE NOVO</font></div></td>
  </tr>
  <tr>
    <td colspan="6" class="fontebranca12"><br>
  ...
  <tr>
    ...
    <td width="68" class="linhatopodir"><div align="center"><span class="fontebranca12">Grupo</span></div></td>
    <td width="130" class="linhatopodir"><div align="center" class="fontebranca12">Descri&ccedil;&atilde;o</div></td>
