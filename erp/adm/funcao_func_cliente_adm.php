...
$query="select * from funcao_func_cliente";
/*
switch($grupo){
...
<title>Lista de Fun&ccedil;&otilde;es</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "funcao_func_cliente_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "funcao_func_cliente_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Fun&ccedil;ao Id </div></td>
    <td width="131" class="linhatopodir"><div align="center" class="fontebranca12">Fun&ccedil;&atilde;o</div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[funcao_id]?></div></td>
    ...
    <td class="linhatopodir"><input name="cargo_id[]" type="checkbox" id="cargo_id[]" value="<?=$row[funcao_id]?>"></td>
  </tr>
  <?php
  }
  ?>
