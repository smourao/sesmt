...
ob_start();
if($cnae!=""){
$query_incluir="INSERT into cnae (cnae, descricao, grau_risco, grupo_cipa) values ('$cnae', '$descricao', '$grau_risco', '$grupo_cipa')";
...
<title>Cadastro de CNAE</title><body bgcolor="#006633">
