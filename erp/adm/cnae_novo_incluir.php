...
ob_start();
if($cnae_novo!=""){
$query_incluir="INSERT into cnae_novo (cnae_novo, descricao, grau_risco, grupo_cipa) values ('$cnae_novo', '$descricao', '$grau_risco', '$grupo_cipa')";
...
//header("location: cnae_novo_adm.php");
}
...
<form name="form1" method="post" action="cnae_novo_incluir.php">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">CNAE NOVO</font></div></td>
    </tr>
	<tr>
      <td colspan="4" class="fontebranca12"><table width="499" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
            ...
            <td width="303"><input name="grupo_cipa" type="text" id="grupo_cipa" size="15"></td>
          </tr>
          <tr>
