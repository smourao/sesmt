...
ob_start();
if($tipo!=""){
$query_incluir="INSERT into tipo_sistema_fixo_contra_incendio (tipo_sistema_fixo_contra_incendio, descricao) values ('$tipo', '$descricao')";
...
header("location: sistema_fixo_contra_incendio_adm.php");
}
...
<title>Cadastrar Sistema de Inc&ecirc;ndio</title><body bgcolor="#006633">
<form action="sistema_fixo_incendio_incluir.php" method="post" name="alarme_contra_incendio" id="alarme_contra_incendio">
