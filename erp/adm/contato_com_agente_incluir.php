...
ob_start();
if($nome!=""){
$query_incluir="INSERT into contato_com_agente (nome, descricao) values ('$nome', '$descricao')";
pg_query($query_incluir) or die ("Erro na query:$query_incluir".pg_last_error($connect));

echo"<script>alert('contato_com_agente Incluído com Sucesso!');</script>";
...
<title>Cadastro de Contatos</title><body bgcolor="#006633">
<form name="form1" method="post" action="contato_com_agente_incluir.php">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">contato_com_agente</font></div></td>
    </tr>
	<tr>
