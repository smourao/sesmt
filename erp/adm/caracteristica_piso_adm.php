...
$query="select * from caracteristica_piso order by caracteristica_piso_id";
$result=pg_query($query) or die("Erro na query: $query".pg_last_error($connect));
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Lista de Caracteristicas do Piso</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "caracteristica_piso_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "caracteristica_piso_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'A') {
	     document.forms[0].action = "caracteristica_piso_alterar.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">Caracter&iacute;stica do Piso </font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="152" class="linhatopodir"><div align="center" class="fontebranca12">Característica do Piso </div></td>
    <td width="225" class="linhatopodir"><div align="center" class="fontebranca12">Descrição</div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[caracteristica_piso_id]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[caracteristica_piso]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10"><?=$row[descricao]?></div></td>
    <td class="linhatopodir" align="center"><input name="caracteristica_piso_id[]" type="checkbox" id="caracteristica_piso_id[]" value="<?=$row[caracteristica_piso_id]?>"></td>
  </tr>
  <?php
  }
  ?>
