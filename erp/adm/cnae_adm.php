...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "cnae_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "cnae_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  	  if(opcao == 'A') {
	     document.forms[0].action = "cnae_alterar.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="5" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">CNAE</font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="85" class="linhatopodiresq"><div align="center" class="fontebranca12">CNAE Id </div></td>
    <td width="153" class="linhatopodir"><div align="center" class="fontebranca12">CNAE</div></td>
