...
echo"<script>
alert('Ventilação Artificial Alterada com Sucesso!');
...
<form action="tipo_ventilacao_artificial_alterar.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">Tipo de Ventilação Artificial</font></div></td>
    </tr>
	<tr>
	...
	<tr>
		<td class="fontebranca12">Tipo Ventilação Artificial</td>
