...
<title>Lista de Tipo de Contato</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "tipo_contato_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "tipo_contato_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Tipo Contato  Id </div></td>
    <td width="131" class="linhatopodir"><div align="center" class="fontebranca12">Tipo Contato </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[tipo_contato_id]?></div></td>
    ...
    <td class="linhatopodir"><input name="tipo_contato_id[]" type="checkbox" id="tipo_id[]" value="<?=$row[tipo_contato_id]?>"></td>
  </tr>
  <?php
  }
  ?>
