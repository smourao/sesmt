...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('				<option value="<p>">Parágrafo &lt;p&gt;</option>');
			document.writeln('				<option value="<h1>">Cabeçalho 1 &lt;h1&gt;</option>');
			document.writeln('				<option value="<h2>">Cabeçalho 2 &lt;h2&gt;</option>');
			document.writeln('				<option value="<h3>">Cabeçalho 3 &lt;h3&gt;</option>');
			document.writeln('				<option value="<h4>">Cabeçalho 4 &lt;h4&gt;</option>');
			document.writeln('				<option value="<h5>">Cabeçalho 5 &lt;h5&gt;</option>');
			document.writeln('				<option value="<h6>">Cabeçalho 6 &lt;h6&gt;</option>');
			document.writeln('				<option value="<address>">Endereço &lt;ADDR&gt;</option>');
			...
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'italic.gif" width="25" height="24" alt="Itálico" title="Itálico" onClick="rteCommand(\'' + rte + '\', \'italic\', \'\')"></td>');
			...
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'left_just.gif" width="25" height="24" alt="Alinhar a esquerda" title="Alinhar a esquerda" onClick="rteCommand(\'' + rte + '\', \'justifyleft\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'centre.gif" width="25" height="24" alt="Centralizar" title="Centralizar" onClick="rteCommand(\'' + rte + '\', \'justifycenter\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'right_just.gif" width="25" height="24" alt="Alinhar a direita" title="Alinhar a direita" onClick="rteCommand(\'' + rte + '\', \'justifyright\', \'\')"></td>');
			...
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'outdent.gif" width="25" height="24" alt="Recúo a esquerda" title="Recúo a esquerda" onClick="rteCommand(\'' + rte + '\', \'outdent\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'indent.gif" width="25" height="24" alt="Recúo a direita" title="Recúo a direita" onClick="rteCommand(\'' + rte + '\', \'indent\', \'\')"></td>');
			...
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'hyperlink.gif" width="25" height="24" alt="Inserir link" title="Inserir link" onClick="insertLink(\'' + rte + '\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'image.gif" width="25" height="24" alt="Adicionar Imagem" title="Adicionar Imagem" onClick="addImage2(\'' + rte + '\')"></td>');
	...
	//		document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'redo.gif" width="25" height="24" alt="Redo" title="Redo" onClick="rteCommand(\'' + rte + '\', \'redo\')"></td>');
		...
		if (!readOnly) document.writeln('<br /><input type="checkbox" id="chkSrc' + rte + '" onclick="toggleHTMLSrc(\'' + rte + '\');" />&nbsp;Ver código');
...
function addImage2(rte){
    window.open("upload_jornal_image.php?rte="+rte+"","Upload","scrollbars=0, width=500,height=250");
}
