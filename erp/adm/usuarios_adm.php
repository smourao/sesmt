...
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "usuarios_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "usuarios_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"> 
	<font color="#000000">Usu&aacute;rios</font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Usuario Id </div></td>
    <td width="131" class="linhatopodir"><div align="center" class="fontebranca12">Login</div></td>
    <td width="147" class="linhatopodir"><div align="center" class="fontebranca12">Grupo</div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10">&nbsp;<?=$row[usuario_id]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10">&nbsp;<?=$row[login]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10">&nbsp;<?=$row[grupo_id]?></div></td>
    <td class="linhatopodir"><div align="center"><input name="usuario_id[]" type="checkbox" id="usuario_id[]" value="<?=$row[usuario_id]?>"></div></td>
  </tr>
  <?php
  }
  ?>
