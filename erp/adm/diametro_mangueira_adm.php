...
$query="select * from diametro_mangueira";
/*
switch($grupo){
...
<title>Lista de Di&acirc;metro</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "diametro_mangueira_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "diametro_mangueira_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Di&acirc;metro  Id </div></td>
    <td width="160" class="linhatopodir"><div align="center" class="fontebranca12">Di&acirc;metro da Mangueira  </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10">&nbsp;<?=$row[diametro_mangueira_id]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10">&nbsp;<?=$row[diametro_mangueira]?></div></td>
    <td class="linhatopodir"><div align="center" class="fontebranca10">&nbsp;<?=$row[descricao]?></div></td>
    <td class="linhatopodir"><div align="center"><input name="id[]" type="checkbox" id="id[]" value="<?=$row[diametro_mangueira_id]?>"></div></td>
  </tr>
  <?php
  }
  ?>
