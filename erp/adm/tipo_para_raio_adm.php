...
$query="select * from tipo_para_raio";
/*
switch($grupo){
...
<title>Lista de Tipo de Para-Raio</title>
<link href="../css_js/css.css" rel="stylesheet" type="text/css">
<script>
<!--
function enviar(opcao) {
	  if(opcao == 'E') {
	     document.forms[0].action = "tipo_para_raio_excluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  if(opcao == 'I') {
	     document.forms[0].action = "tipo_para_raio_incluir.php";
		 document.forms[0].target = "_self";
		 document.forms[0].submit();
      }
	  }
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="fontebranca12"><div align="center" class="fontepreta14bold"><font color="#000000">Tipo Para-Raio </font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="191" class="linhatopodiresq"><div align="center" class="fontebranca12">Tipo Para-Raio  Id </div></td>
    <td width="160" class="linhatopodir"><div align="center" class="fontebranca12">Tipo Para-Raio </div></td>
  ...
  ?>
  <tr>
    <td class="linhatopodiresq"><div align="center" class="fontebranca10"><?=$row[tipo_para_raio_id]?></div></td>
    ...
    <td class="linhatopodir"><input name="id[]" type="checkbox" id="id[]" value="<?=$row[tipo_para_raio_id]?>"></td>
  </tr>
  <?php
  }
  ?>
