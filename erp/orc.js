...
if(http.readyState == 4)
{
    ...
    var tmp = lista[0].split("|");
       ...
       for(var x=0;x<lista.length -1;x++){
          ...
          retorno += "<td align=center><center><font size=1><a href='javascript:remove_orcamento_produto("+data[0]+");' class=excluir><font size=1>Excluir</font></a> <P> <a href='edita_orc_prod.php?iid="+data[0]+"&cod_cliente="+data[10]+"&cod_filial="+data[11]+"&orcamento="+data[12]+"' class=editar><font size=1 color=white>Editar</font></a></font></td>";
