<?PHP
if(!isset($_SESSION[mrec])){
    $_SESSION[mrec] = date("m");
}
if(!isset($_SESSION[yrec])){
    $_SESSION[yrec] = date("Y");
}
...
<div align=right>
<img src='imprimir.gif' border=0 width=20 height=20 onclick="window.open('print_receitas.php?m=<?PHP echo $mes;?>&y=<?PHP echo $ano;?>','Receitas', 'height = 500, width = 700, scrollbars=yes')" style="cursor:pointer;">
</div>
</td>
</tr>
</table>
...
<?PHP
   ...
   echo "<center><a href=\"javascript:location.href='?s=receitas&m=$mes&y=".($ano-1)."'\" class=fontebranca12><<</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:location.href='?s=receitas&m=$p_mes&y=$p_ano'\" class=fontebranca12><</a>&nbsp;&nbsp;&nbsp;&nbsp;<b>".$meses[ltrim($mes, "0")]."/{$ano}</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:location.href='?s=receitas&m=$n_mes&y=$n_ano'\" class=fontebranca12>></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:location.href='?s=receitas&m=$mes&y=".($ano+1)."'\" class=fontebranca12>>></a></center>";
?>
...
echo"
<tr>
   <td align=right colspan=3>&nbsp;<b>Total Creditado</b></td>
