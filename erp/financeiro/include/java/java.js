...
div.innerHTML = "<center><input type=text name='titulo"+ntopicos+"' id='titulo"+ntopicos+"' size=20 value='"+fieldname+"'> [<a href=\"javascript:checkc('titulo"+ntopicos+"', 'span"+ntopicos+"', '"+ntopicos+"');\"\">Confirmar</a> | <a href=\"javascript:removeTopic("+ntopicos+");\"\">Excluir Tópico</a>]<br>";
...
document.getElementById("tosend").innerHTML = "<input type=submit id=enviar name=enviar value='Versão para Impressão'>";
  }
}
