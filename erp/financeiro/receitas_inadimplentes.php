...
<tr>
<td>
<b>Receitas Inadimplentes</b>
<div align=right>
<img src='imprimir.gif' border=0 width=20 height=20 onclick="window.open('print_receitas_inadimplentes.php?m=<?PHP echo $mes;?>&y=<?PHP echo $ano;?>','Receitas', 'height = 500, width = 700, scrollbars=yes')" style="cursor:pointer;">
</div>
</td>
</tr>
</table>
...
<?PHP
  ...
  if($mes >=12){
   ...
   echo "<center><a href=\"javascript:location.href='?s=receitas_inadimplentes&m=$p_mes&y=$p_ano'\" class=fontebranca12><<</a>  <b>".$meses[ltrim($mes, "0")]."/{$ano}</b>  <a href=\"javascript:location.href='?s=receitas_inadimplentes&m=$n_mes&y=$n_ano'\"  class=fontebranca12>>></a></center>";
?>
...
<tr>
   ...
   <td bgcolor='".$bg_color[($x%2)]."' align=center width=50><font color=black><center><div id='d{$data[$x]['rec_id']}'  onclick=\"javascript:setTimeout('receita_total()', 1500);\">";
