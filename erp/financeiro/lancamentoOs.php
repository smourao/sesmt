...
if($tipo_debito == 0){
	...
	$relatoriosql = "INSERT INTO financeiro_relatorio (cod_fatura,titulo,valor,status,pago,historico,data_lancamento,semana,ano)VALUES ('{$max[0]}','".addslashes($_POST['titulo'])."',$valor,1,1,'".addslashes($_POST['historico'])."','$hoje','$semana','$ano');";
