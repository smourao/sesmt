...
$sql = "SELECT * FROM erp_cliente_message WHERE cliente_id = '{$cod_cliente}' AND mensagem = '{$mensagem}'";
$result = pg_query($sql);

   $sql = "INSERT INTO erp_cliente_message (razao_social, cliente_id, titulo, mensagem,
