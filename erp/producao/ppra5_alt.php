...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="50%" align="left">
			...
			<span class="style2">Serviços Especializados de Segurança e <br>
		    ...
		    <p align="center">
			<font color="#006633" face="Verdana, Arial, Helvetica, sans-serif">
	        <span class="style2">Segurança do Trabalho e Higiene Ocupacional</span>
			</font></p>
...
/*************** DADOS DO CLIENTE ****************/
	...
	if($result_cli){
		...
		$row_cli = pg_fetch_array($result_cli);
			...
			echo "<tr> <td class=\"style1\" align=right> Endereço: </td>        <td> <b>&nbsp;&nbsp;&nbsp; $row_cli[endereco_cliente]</b> </td> </tr>";
...
/*************** DADOS DO SETOR ****************/
	...
	if($result_set){
		...
		echo "<tr> <td class=\"style1\" align=right> Descrição do Setor: </td> <td> <b>&nbsp;&nbsp;&nbsp; $row_set[desc_setor]</b> </td> </tr>";
	}
...
/*************** DADOS DO SETOR DO CLIENTE ****************/
	...
	if( pg_num_rows($result_cli_set)>0 ){
		...
		echo "
			<tr>
				<td class=\"style1\" width=300  align=right>  Observações do Setor: &nbsp; 
			...
			<tr>
				<td class=\"style1\" align=right>  Tipo de Ventilaçã Artificial do Setor: &nbsp; 
				<td><b>&nbsp;  $row_cli_set[nome_vent_art]</b> </td>
			</tr>
			<tr>
				<td class=\"style1\" align=right>  Tipo de Ventilaçã Natural do Setor: &nbsp; 
				<td><b>&nbsp;  $row_cli_set[nome_vent_nat]</b></td>
			</tr>
			<tr>
				<td class=\"style1\" align=right>  Tipo de Edificação do Setor: &nbsp; 
	...
	if ( pg_num_rows($result_risco)>0 ){
		...
		while($row_risco = pg_fetch_array($result_risco)){
			echo "<tr> <td class=\"style1\" align=right> Código: </td>                      <td> <b>&nbsp;&nbsp;&nbsp;" . str_pad($row_risco[num_agente_risco], 4, "0", STR_PAD_LEFT) . " &nbsp;</b> </td> </tr>";
			echo "<tr> <td class=\"style1\" align=right> Agente causador do Risco: </td>    <td> <b>&nbsp;&nbsp;&nbsp; $row_risco[nome_agente_risco] &nbsp;</b> </td> </tr>";
			echo "<tr> <td class=\"style1\" align=right> Descrição do Risco: </td>          <td> <b>&nbsp;&nbsp;&nbsp; $row_risco[descricao_risco] &nbsp;</b> </td> </tr>";
...
/************** DADOS DAS MOBILIAS CADASTRADAS ****************/
	...
	if( pg_num_rows($result_mob)>0 ){
		...
		while($row_mob = pg_fetch_array($result_mob)){
			echo "<tr> <td class=\"style1\" align=right> Descrição da Mobília: </td>      <td> <b>&nbsp;&nbsp;&nbsp; <b>$row_mob[descricao_mobilia]</b> </td> </tr>";
			echo "<tr> <td class=\"style1\" align=right> Ruído no local da Mobília: </td> <td> <b>&nbsp;&nbsp;&nbsp; <b>$row_mob[ruido]</b>  </td> </tr>";
			echo "<tr> <td class=\"style1\" align=right> Imuminação na Mobília: </td>     <td> <b>&nbsp;&nbsp;&nbsp; <b>$row_mob[iluminancia]</b>  </td> </tr>";
		}
	}
/************** DADOS DAS SUGESTÕES ****************/
...
<table width="800" border="2" align="center" cellpadding="0" cellspacing="0">
    <tr>
    	<th colspan="5"><br>
			<div class="style1">FUNCIONÁRIO<br></div>&nbsp; <br>
		</th>
    </tr>
    <tr>
    	<th colspan="5">
  ...
  <tr>
    <td width="10%"><div align="center" class="style1"><strong>Código</strong></div></td>
