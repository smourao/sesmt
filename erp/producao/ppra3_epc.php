...
<td align="center" colspan="4" bgcolor="#009966" ><b><br>CADASTRO DE EQUIPAMENTOS DE PROTEÇÃO COLETIVA<br>&nbsp;</b></td>
	...
	<tr>
		<td align="center" colspan="4">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" name="btn_concluir" value="Avançar &gt;&gt;" style="width:100px;" onClick="location.href='cad_extintor.php?cliente=<?PHP echo $_GET[cliente];?>&id_ppra=<?php echo $_GET[id_ppra];?>&setor=<?php echo $setor; ?>&y=<?php echo $ano; ?>&fid=<?PHP echo $_GET[fid];?>';" title="Clique aqui para avançar">
			<br>&nbsp;
