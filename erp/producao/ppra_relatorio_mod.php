	...
	<div id="div_position" style="position:relative;left:-40px;"><img src="../img/uno_top.jpg" width="154" height="219"></div>
		...
		<td align="center"><p><h1><b>Programa<p>e<p>Prevenção<p>de<p>Riscos<p>Ambientais</b></h1><p><p>
			...
			<td align="left"><font class="fontepreta12">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NR 9 - MTE</b></font>
				<div id="grfg"></div><div id="div_position"><img src="../img/bruna_carimbo.jpg" width="180" height="110"><!--img src="../img/bruna_carimbo_rubrica.jpg" width="180" height="110"--></div>
			</td>
			</tr>
			</table>
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<tr>
		<td valign="top">
		<table align="left" width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
		...
		<td>
		<table align="right" width="398" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
	...
	<tr>
		<td align="left" valign="top" width="349" class="fontepreta12"><b>CARACTERÍSTICAS:</b><br>
		<table align="left" width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
		...
		<td align="left" valign="top" width="349" class="fontepreta12"><b>IDENTIFICAÇÃO QUALITATIVA DE AGENTE NOCIVO:</b><br>
<?php
...
$fm = 3; //original = 4 -> Fator de multiplicação
...
<table align="center" width="700" height="<?php echo $height; ?>" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="699" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				<td width="131" align="center" class="fontepreta12">Setor&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="75" align="center" class="fontepreta12">Agente</td>
				<td width="78" align="center" class="fontepreta12">Nível&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="85" align="center" class="fontepreta12">Grau de Itensidade e efeitos</td>
				<td width="80" align="center" class="fontepreta12">Danos à Saúde</td>
				<td width="78" align="center" class="fontepreta12">Escala de Ação</td>
				<td width="170" align="center" class="fontepreta12">Ações Necessárias</td>
			</tr>
			<tr>
	...
	<td class="tabela" valign="top">
		...
		<table align="center" width="600" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
			<tr>
				...
				<td align="center"><img src="../img/bruna_carimbo2.jpg" border="0"><!--img src="../img/bruna_assinatura_e_rubrica.jpg" border="0"--></td>
			</tr>
			<tr>
