...
<table width="800" border="2" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<h2>Avaliações indicados para o Setor</h2>
		<br></td>
	</tr>
	<tr>
	...
	<tr>
		<th colspan="2" bgcolor="#009966">
			...
			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
			<input name="avancar" type="button" id="btn_novo" onClick="location.href='setor_prog_complementares.php?setor=<?php echo $setor; ?>';" value="Avançar >>" style="width:100;">
		</th>
	</tr>
</table>
<p>
