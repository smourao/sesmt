...
{ // verificar se houve o comando de enviar
	...
	if ($result_sql){
		echo "<script>alert('Avaliações atualizadas com sucesso!');</script>";
	}
}
...
<table width="800" border="2" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<h2>Avaliações indicados para a  Função</h2>
		<br></td>
	</tr>
	<tr>
		<td width="400" align="center"><h3>FUNÇÃO</h3></td>
		<td width="400" align="center"><h3>AVALIAÇÕES AMBIENTAIS</h3></td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<th colspan="2" bgcolor="#009966">
			...
			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
			<input name="avancar" type="button" id="btn_novo" onClick="MM_goToURL('parent','prog_complementares.php?funcao=<?php echo $funcao; ?>'); return document.MM_returnValue" value="Avançar >>" style="width:100;">			
