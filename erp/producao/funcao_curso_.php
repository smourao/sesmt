...
<title>..:: SESMT &gt;&gt; Fun&ccedil;&atilde;o - Curso ::..</title>
...
<table width="800" border="2" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td align="center"> 
			<textarea name="funcao_curso" rows="8" style="width:350px; font-size:12px;"><?php echo $row_funcao[funcao_curso]; ?></textarea> <br>&nbsp;		</td>
	</tr>
	<tr>
