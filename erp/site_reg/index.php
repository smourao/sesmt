...
<html>
<head>
<title>Cadastros Realizados no Site</title>
...
<table width="700" border="2" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <br>CADASTROS REALIZADOS NO SITE<br>&nbsp;</th>
    </tr>
    <tr>
		<tr>
			...
			<br>&nbsp;
<?PHP
if($_GET[action] != "propriedade_de_contrato"){
?>
                <input name="btn_add" type="button" id="btn_ini" onClick="location.href='?action=list'" value="Início" style="width:120;">
                <input name="btn_sair" type="button" id="btn_sair" onClick="location.href='../adm/'" value="Sair" style="width:120;">
<?PHP
}else{
               echo "<input name=btn_sair type=button id=btn_sair onClick=\"history.go(-1);\" value=\"Voltar\" style=\"width:120;\">";
}
?>
			<br>&nbsp;
			</th>
