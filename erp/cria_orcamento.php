...
<table width=\"100%\" border=\"0\" cellpadding=\"4\" cellspacing=\"0\" bordercolor=\"#000000\">
   ...
   for($x=0;$x<pg_num_rows($result);$x++){
       //adiciona todos os códigos de produtos dentro de um array; usado pra localizar cursos.
...
<select name=condicao_pagamento id=condicao_pagamento onchange="change_condicao(<?PHP echo $orc_n;?>, this.value);">
   ...
   <option value=120 <?PHP if($orc_info[condicao_de_pagamento] == 120){ echo " selected ";}?>>Condição de Pagamento - 12 parcelas sem juros</option>
</select>
<BR>
Prazo de Entrega:
